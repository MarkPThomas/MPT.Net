...
namespace MPT.Reporting.Core.UnitTests
{
    ...
    public class LoggerEventArgsTests
    {
        ...
        public void Initialize_With_Message_Contains_Message_And_Defaults()
        {
            ...
            LoggerEventArgs loggerEventArg = new LoggerEventArgs(new MessengerEventArgs(expectedMessage));
        ...
        public void Initialize_With_Exception_Contains_Message_And_Exception_And_Defaults()
        {
            ...
            Assert.AreEqual(defaultMessageType, loggerEventArg.MessageType);
            Assert.AreEqual(defaultHandled, loggerEventArg.Handled);
            Assert.AreEqual(string.Empty, loggerEventArg.Parameters);
        }
        ...
        [Test]
        public void Initialize_With_Exception_And_Parameters_Contain_Empty_Message_And_Exception_And_Parameters_And_Defaults()
        {
            string key1 = "Key1:";
            string value1 = "Value1";
            string key2 = "Key2:";
