...
#Region "Methods: Public"
    ...
    Public Shared Sub OpenExplorerAtFolder(ByVal folderPath As String,
        ...
        Catch ex As Exception
            RaiseEvent Log(New LoggerEventArgs(ex, Nothing, NameOfParam(Function() folderPath), folderPath))
        End Try
        ''ncrunch: no coverage end
    End Sub
    ...
    Public Shared Sub OpenExplorerAtFile(ByVal filePath As String,
        ...
        Catch ex As Exception
            RaiseEvent Log(New LoggerEventArgs(ex, Nothing, NameOfParam(Function() filePath), filePath))
        End Try
        ''ncrunch: no coverage end
    End Sub
