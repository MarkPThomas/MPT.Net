...
#Region "Querying"
    ...
    Public Shared Function ReadableWriteableDeletableDirectory(ByVal pathDirectory As String) As Boolean
        ...
        Catch ex As Exception
            RaiseEvent Log(New LoggerEventArgs(ex, Nothing, NameOfParam(Function() pathDirectory), pathDirectory))
            Return False
        End Try
...
#Region "Component Functions"
    ...
    Public Shared Sub ComponentCreateDirectory(ByVal path As String)
        ...
        Catch ex As Exception
            RaiseEvent Log(New LoggerEventArgs(ex, Nothing, NameOfParam(Function() path), path))
        End Try
    End Sub
