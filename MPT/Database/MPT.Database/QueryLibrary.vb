...
#Region "Methods"
    ...
    Public Shared Function TranslateQuery(ByVal p_query As String) As String
        ...
        If p_query.Length > 0 Then
            While StringLibrary.StringExistInName(p_query, "LIKE")
                p_query = StringLibrary.ReplaceInText(p_query, "LIKE", "= '")
            End While
        End If
        ...
        Try
            If p_query.Count > 0 Then
                For i = 1 To Len(p_query)
                    ...
                    If StringLibrary.StringsMatch(Mid(p_query, i, 4), "LIKE") Then
                        keyEnd = i - 2
                        valStart = i + 5
                    ElseIf StringLibrary.StringsMatch(Mid(p_query, i, 3), "AND") Then
                        valEnd = i - 2
