...
{
    [TestFixture]
    public class SumDifferenceSetOperatorTests
    {
        #region Equality
        ...
        public void Equals(string value1, string value2, bool expectedEqual)
        {
            ...
            SumDifferenceSet set2 = new SumDifferenceSet(value2);
        ...
        {
            SumDifferenceSet set1 = new SumDifferenceSet(value1);
            object set2 = new SumDifferenceSet(value2);
        ...
        {
            SumDifferenceSet set1 = new SumDifferenceSet("Foo");
        ...
        {
            SumDifferenceSet set1 = new SumDifferenceSet("Foo");
            SumDifferenceSet setEmpty = new SumDifferenceSet(string.Empty);
            ...
            setEmpty = new SumDifferenceSet(new PrimitiveUnit(string.Empty));
        ...
        //    set1 = new SumDifferenceSet(new PrimitiveUnit(value1));
        ...
        //{
        //    SumDifferenceSet set1 = new SumDifferenceSet(value1, new PrimitiveUnit(power1));
        //    SumDifferenceSet set2 = new SumDifferenceSet(value2, new PrimitiveUnit(power2));
        ...
        //    set1 = new SumDifferenceSet(new PrimitiveUnit(value1, new PrimitiveUnit(power1)));
        //    set2 = new SumDifferenceSet(new PrimitiveUnit(value2, new PrimitiveUnit(power2)));
        ...
        {
            SumDifferenceSet set1 = new SumDifferenceSet("Foo");
            IBase iBaseEmpty = new SumDifferenceSet(string.Empty);
