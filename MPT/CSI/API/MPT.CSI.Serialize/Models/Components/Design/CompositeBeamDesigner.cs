...
namespace MPT.CSI.Serialize.Models.Components.Design
{
    ...
    /// </summary>
    /// <seealso cref="DesignerMetal{DesignCompositeBeam}" />
    public sealed class CompositeBeamDesigner : DesignerMetal<CompositeBeamDesignResults>
    {
        #region Fields & Properties
        public CompositeBeamDesignPreferences CompositeBeamDesignPreferences { get; set; }
        #endregion
