...
{
    public class SteelColdFormedDesigner : DesignerMetal<SteelColdFormedDesignResults>
    {
        #region Fields & Properties
        public SteelColdFormedDesignPreferences SteelColdFormedDesignPreferences { get; set; }
        #endregion
