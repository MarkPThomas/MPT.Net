...
namespace MPT.CSI.Serialize.Models.Components.Definitions.Masses
{
    ...
    public class Mass
    {
        ...
        public bool IsLocalCoordinateSystem { get; internal set; }
        /// <summary>
        /// The mass
        /// </summary>
        private readonly MassProperties _mass;
        /// <summary>
        /// The mass as weight
        /// </summary>
        private MassWeightProperties _massAsWeightProperties;
        /// <summary>
        /// The mass as volume
        /// </summary>
        private MassVolumeProperties _massAsVolumeProperties;
        ...
        /// </summary>
        /// <returns>MassWeightProperties.</returns>
        public MassWeightProperties GetMassByWeight()
        {
            // TODO: Finish GetMassByWeight
            return _massAsWeightProperties;
        }
        ...
        /// <returns>MassVolumeProperties.</returns>
        public MassVolumeProperties GetMassByVolume(string materialProperty)
        {
            // TODO: Finish GetMassByVolume.
            return _massAsVolumeProperties;
        }
