...
namespace MPT.CSI.Serialize.Models.Components.Definitions.CrossSections.Areas
{
    ...
    public class DeckFilled : DeckExtended<DeckFilledProperties>
    {
        ...
        internal static DeckFilled Factory(string uniqueName, DeckFilledProperties properties = null)
        {
            DeckFilled areaSection = new DeckFilled(uniqueName) { _properties = properties };
        ...
        protected DeckFilled(string name) : base(name)
        {
