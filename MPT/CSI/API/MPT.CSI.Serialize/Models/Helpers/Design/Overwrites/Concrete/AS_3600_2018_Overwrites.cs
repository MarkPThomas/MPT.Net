...
// ***********************************************************************
// <copyright file="AS_3600_2018_Overwrites.cs" company="">
//     Copyright ©  2018
// </copyright>
// <summary></summary>
// ***********************************************************************
...
namespace MPT.CSI.Serialize.Models.Helpers.Design.Overwrites.Concrete
{
    ...
    public class AS_3600_2018_Overwrites : ConcreteDesignOverwriteProperties
    {
        ...
        /// </summary>
        /// <value>The km major.</value>
        public double? kmMajor { get; set; } = null;
        ...
        /// </summary>
        /// <value>The km minor.</value>
        public double? kmMinor { get; set; } = null;
        #endregion
