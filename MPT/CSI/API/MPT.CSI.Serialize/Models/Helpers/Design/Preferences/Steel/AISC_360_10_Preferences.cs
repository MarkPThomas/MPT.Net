...
// ***********************************************************************
// <copyright file="AISC_360_10_Preferences.cs" company="">
//     Copyright ©  2018
// </copyright>
// <summary></summary>
// ***********************************************************************
...
namespace MPT.CSI.Serialize.Models.Helpers.Design.Preferences.Steel
{
    ...
    public class AISC_360_10_Preferences : SteelDesignPreferenceProperties
    {
        ...
        /// <summary>
        /// Indicates the provisions used to check/design the steel members.
        /// </summary>
        public enum DesignProvisions
        {
            /// <summary>
            /// The LRFD
            /// </summary>
        ...
        /// <summary>
        /// Indicates the provision used to check/design the steel members.
        /// </summary>
        /// <value>The design provision.</value>
        public DesignProvisions DesignProvision { get; set; } = DesignProvisions.LRFD;
        ...
        public double NLCoeff { get; set; } = 0.002;
