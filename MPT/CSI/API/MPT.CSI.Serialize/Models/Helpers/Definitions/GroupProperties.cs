...
namespace MPT.CSI.Serialize.Models.Helpers.Definitions
{
    ...
    /// </summary>
    public class GroupProperties : ModelProperty
    {
        /// <summary>
        ...
        /// <summary>
        /// True: The group is selected to be used as a steel frame design group.
        /// </summary>
        /// <value><c>true</c> if [selected for steel design]; otherwise, <c>false</c>.</value>
        public bool SelectedForSteelDesign { get; set; } = true;

        /// <summary>
        /// True: The group is selected to be used as a defining colf formed frame design group.
        /// </summary>
        /// <value><c>true</c> if [selected for cold formed design]; otherwise, <c>false</c>.</value>
        public bool SelectedForColdFormedDesign { get; set; } = true;

        /// <summary>
        /// True: The group is selected to be used as a defining alumnimum frame design group.
        /// </summary>
        /// <value><c>true</c> if [selected for aluminum design]; otherwise, <c>false</c>.</value>
        public bool SelectedForAluminumDesign { get; set; } = true;
