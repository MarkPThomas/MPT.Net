...
namespace MPT.CSI.Serialize.Models.Helpers.Definitions.Objects.Frames
{
    ...
    /// </summary>
    public class FrameOutputStation : ModelProperty
    {
        /// <summary>
        ...
        /// <summary>
        /// True: No additional output stations are added at the ends of line elements when the frame object is internally meshed.
        /// </summary>
        /// <value><c>true</c> if [no output and design at element ends]; otherwise, <c>false</c>.</value>
        public bool NoOutputAndDesignAtElementIntersections { get; set; }
