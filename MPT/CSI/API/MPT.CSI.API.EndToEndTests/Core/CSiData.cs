...
namespace MPT.CSI.API.EndToEndTests.Core
{
    ...
    {
        // TODO: Make pathResources dynamic?
        public const string pathResources = @"D:\GitHub\personal\MPT.Net\MPT\CSI\API\MPT.CSI.API.EndToEndTests" + @"\Resources"; //Directory.GetParent(Directory.GetCurrentDirectory()).Parent.FullName + @"\Resources";
        ...
        public const string pathApp = @"C:\Program Files\Computers and Structures\ETABS 17\ETABS.exe";
        public const string extension = ".edb";
        public const string versionName = "17.0.1";
        public const double versionNumber = 17.01;
        public const string processName = "ETABS";
#endif
