...
namespace MPT.CSI.API.EndToEndTests.Core.Program.ModelBehavior.Definition.Property
{
    ...
    public class FrameSection_Get : CsiGet
    {
        ...
        {
            string[] names = _app.Model.Definitions.Properties.FrameSection.GetNameList();
        ...
        public void GetModifiers_Has_No_Modifers()
        {
            ...
            FrameModifier modifier = _app.Model.Definitions.Properties.FrameSection.GetModifiers(CSiDataLine.NameSectionFrameCol);
        ...
        public void GetModifiers_Has_Modifers()
        {
            ...
            FrameModifier modifier = _app.Model.Definitions.Properties.FrameSection.GetModifiers(CSiDataLine.NameSectionFrame);
