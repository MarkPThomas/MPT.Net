...
namespace MPT.CSI.API.EndToEndTests.Core.Program.ModelBehavior.ObjectModel
{
    ...
    public class AreaObject_Get : CsiGet
    {
        ...
        {
            bool isSelected = _app.Model.ObjectModel.AreaObject.GetSelected(CSiDataArea.NameObjectShellThin);
        ...
        {
            string[] names = _app.Model.ObjectModel.AreaObject.GetNameList();
        ...
        {
            DirectionCosines directionCosines = _app.Model.ObjectModel.AreaObject.GetTransformationMatrix(CSiDataArea.NameObjectShellThin);
        ...
        {
            DirectionCosines directionCosines = _app.Model.ObjectModel.AreaObject.GetTransformationMatrix(CSiDataArea.NameObjectShellThin, isGlobal: false);
        ...
        {
            string[] points = _app.Model.ObjectModel.AreaObject.GetPoints(CSiDataArea.NameObjectShellThin);
        ...
        public void GetGUID()
        {
            string guid = _app.Model.ObjectModel.AreaObject.GetGUID(CSiDataArea.NameObjectShellThin);
...
#endif
            string[] elementNames = _app.Model.ObjectModel.AreaObject.GetElement(CSiDataArea.NameObjectShellThin);
        ...
        public void GetElement_Meshed()
        {
            ...
            _app.Model.SetPresentCoordSystem(CSiData.CoordinateSystemCustom);
#endif
            string[] elementNames = _app.Model.ObjectModel.AreaObject.GetElement(CSiDataArea.NameObjectShellThick);
        ...
        public void GetGroupAssign() // Verification Incident 15096 
        {
            ...
            _app.Model.ObjectModel.AreaObject.GetGroupAssign(objectName, out var groupNames);
        ...
        {
            _app.Model.ObjectModel.AreaObject.GetLocalAxes(CSiDataArea.NameObjectShellThin, out var angleOffset, out var isAdvanced);
        ...
        {
            string propertyName = _app.Model.ObjectModel.AreaObject.GetSection(CSiDataArea.NameObjectShellThin);
        ...
        public void GetMass()
        {
            double masses = _app.Model.ObjectModel.AreaObject.GetMass(CSiDataArea.NameObjectShellThin);
        ...
        {
            AreaModifier modifier = _app.Model.ObjectModel.AreaObject.GetModifiers(CSiDataArea.NameObjectShellThin);
