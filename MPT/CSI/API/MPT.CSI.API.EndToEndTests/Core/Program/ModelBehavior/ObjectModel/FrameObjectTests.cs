...
namespace MPT.CSI.API.EndToEndTests.Core.Program.ModelBehavior.ObjectModel
{
    ...
    public class FrameObject_Get : CsiGet
    {
        ...
        {
            bool isSelected = _app.Model.ObjectModel.FrameObject.GetSelected(CSiDataLine.NameObjectFrame);
        ...
        {
            string[] names = _app.Model.ObjectModel.FrameObject.GetNameList();
        ...
        {
            string[] points = _app.Model.ObjectModel.FrameObject.GetPoints(CSiDataLine.NameObjectFrame);
        ...
        public void GetGUID()
        {
            string guid = _app.Model.ObjectModel.FrameObject.GetGUID(CSiDataLine.NameObjectFrame);
        ...
        public void GetElement()
        {
            ...
            string[] elementNames = _app.Model.ObjectModel.FrameObject.GetElement(CSiDataLine.NameObjectFrame);
        ...
        public void GetGroupAssign() // Verification Incident 15096
        {
            ...
            _app.Model.ObjectModel.FrameObject.GetGroupAssign(objectName, out var groupNames);
        ...
        {
            _app.Model.ObjectModel.FrameObject.GetLocalAxes(CSiDataLine.NameObjectFrame, out var angleOffset, out var isAdvanced);
        ...
        {
            string propertyName = _app.Model.ObjectModel.FrameObject.GetSection(CSiDataLine.NameObjectFrame);
        ...
        public void GetMass()
        {
            double masses = _app.Model.ObjectModel.FrameObject.GetMass(CSiDataLine.NameObjectFrame);
