...
namespace MPT.CSI.API.EndToEndTests.Core.Program.ModelBehavior.ObjectModel
{
    ...
    public class PointObject_Get : CsiGet
    {
        ...
        {
            bool isSelected = _app.Model.ObjectModel.PointObject.GetSelected(CSiDataPoint.NameObject);
        ...
        {
            string[] names = _app.Model.ObjectModel.PointObject.GetNameList();
        ...
        {
            DirectionCosines directionCosines = _app.Model.ObjectModel.PointObject.GetTransformationMatrix(CSiDataPoint.NameObject);
        ...
        {
            DirectionCosines directionCosines = _app.Model.ObjectModel.PointObject.GetTransformationMatrix(CSiDataPoint.NameObject, isGlobal: false);
            
            // Row 1
            Assert.That(directionCosines.X1, Is.EqualTo(0.707).Within(0.001));
            Assert.That(directionCosines.Y1, Is.EqualTo(0.707).Within(0.001));
            Assert.That(directionCosines.Z1, Is.EqualTo(0));

            // Row 2
            Assert.That(directionCosines.X2, Is.EqualTo(-0.707).Within(0.001));
            ...
            Assert.That(directionCosines.X3, Is.EqualTo(0));
            Assert.That(directionCosines.Y3, Is.EqualTo(0));
            Assert.That(directionCosines.Z3, Is.EqualTo(1).Within(0.001));
        }

        [Test]
        public void GetTransformationMatrix_Of_Transformed_Axis()
        {
            DirectionCosines directionCosines = _app.Model.ObjectModel.PointObject.GetTransformationMatrix(CSiDataPoint.NameObjectTransformedAxis);
        ...
        public void GetGUID()
        {
            string guid = _app.Model.ObjectModel.PointObject.GetGUID(CSiDataPoint.NameObject);
...
#endif
            string[] elementNames = _app.Model.ObjectModel.PointObject.GetElement(CSiDataPoint.NameObject);
        ...
        public void GetGroupAssign() // Verification Incident 15096
        {
            ...
            _app.Model.ObjectModel.PointObject.GetGroupAssign(objectName, out var groupNames);
        ...
        {
            _app.Model.ObjectModel.PointObject.GetLocalAxes(CSiDataPoint.NameObject, out var angleOffset, out var isAdvanced);
        ...
        {
            _app.Model.ObjectModel.PointObject.GetLocalAxes(CSiDataPoint.NameObjectTransformedAxis, out var angleOffset, out var isAdvanced);
        ...
        {
            _app.Model.ObjectModel.PointObject.GetLocalAxes(CSiDataPoint.NameObjectTransformedAxisAdvanced, out var angleOffset, out var isAdvanced);
        ...
        {
            Mass masses = _app.Model.ObjectModel.PointObject.GetMass(CSiDataPoint.NameObject);
        ...
        {
            Mass masses = _app.Model.ObjectModel.PointObject.GetMass(CSiDataPoint.NameObjectMass);
