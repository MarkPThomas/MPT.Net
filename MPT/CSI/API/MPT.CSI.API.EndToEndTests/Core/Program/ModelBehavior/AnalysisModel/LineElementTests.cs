...
namespace MPT.CSI.API.EndToEndTests.Core.Program.ModelBehavior.AnalysisModel
{
    ...
    public class LineElement_Get : CsiGetAnalysisModel
    {
        ...
        {
            string[] names = _app.Model.AnalysisModel.LineElement.GetNameList();
        ...
        {
            DirectionCosines directionCosines = _app.Model.AnalysisModel.LineElement.GetTransformationMatrix(CSiDataLine.NameElementFrame);
        ...
        {
            string[] points = _app.Model.AnalysisModel.LineElement.GetPoints(CSiDataLine.NameElementFrameOffsets);
        ...
        {
            string[] points = _app.Model.AnalysisModel.LineElement.GetPoints(CSiDataLine.NameElementFrame);
        ...
        {
            string objectName = _app.Model.AnalysisModel.LineElement.GetObject(CSiDataLine.NameElementFrameOffsets);
        ...
        {
            string objectName = _app.Model.AnalysisModel.LineElement.GetObject(CSiDataLine.NameElementFrame);
        ...
        public void GetObject_Cable()
        {
            _app.Model.AnalysisModel.LineElement.GetObject(CSiDataLine.NameElementCable, 
                out var objectName,
                out var objectType,
                out var relativeDistanceI,
                out var relativeDistanceJ);
        ...
        {
            FrameModifier modifier = _app.Model.AnalysisModel.LineElement.GetModifiers(CSiDataLine.NameElementFrame);
        ...
        {
            string propertyName = _app.Model.AnalysisModel.LineElement.GetSection(CSiDataLine.NameElementFrame);
        ...
        {
            _app.Model.AnalysisModel.LineElement.GetMaterialTemperature(CSiDataLine.NameElementFrame, out var temperature, out var patternName);
