...
namespace MPT.CSI.API.EndToEndTests.Core.Program.ModelBehavior.AnalysisModel
{
    ...
    public class AreaElement_Get : CsiGetAnalysisModel
    {
        ...
        {
            string[] names = _app.Model.AnalysisModel.AreaElement.GetNameList();
        ...
        {
            string[] points =_app.Model.AnalysisModel.AreaElement.GetPoints(CSiDataArea.NameElementShellThin);
        ...
        {
            string[] points = _app.Model.AnalysisModel.AreaElement.GetPoints(CSiDataArea.NameElementShellThick);
        ...
        {
            string objectName =_app.Model.AnalysisModel.AreaElement.GetObject(CSiDataArea.NameElementShellThin);
        ...
        {
            string objectName = _app.Model.AnalysisModel.AreaElement.GetObject(CSiDataArea.NameElementShellThick);
        ...
        {
            string propertyName = _app.Model.AnalysisModel.AreaElement.GetSection(CSiDataArea.NameElementShellThin);
