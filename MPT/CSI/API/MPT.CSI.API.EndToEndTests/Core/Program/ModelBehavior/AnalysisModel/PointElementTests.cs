...
namespace MPT.CSI.API.EndToEndTests.Core.Program.ModelBehavior.AnalysisModel
{
    ...
    public class PointElement_Get : CsiGetAnalysisModel
    {
        ...
        {
            string[] names = _app.Model.AnalysisModel.PointElement.GetNameList();
        ...
        {
            DirectionCosines directionCosines = _app.Model.AnalysisModel.PointElement.GetTransformationMatrix(CSiDataPoint.NameElement);
        ...
        {
            string objectName = _app.Model.AnalysisModel.PointElement.GetObject(CSiDataPoint.NameElement);
        ...
        {
            AngleLocalAxes angleOffset = _app.Model.AnalysisModel.PointElement.GetLocalAxes(CSiDataPoint.NameElement);
