...
{
    [TestFixture]
    public class CSiModelTests_Get : CsiGet
    {
        [Test]
        ...
        {
            double mergeTolerance = _app.Model.GetMergeTolerance();
        ...
        public void GetProjectInfo()
        {
            ...
            _app.Model.GetProjectInfo(out var projectInfoItems, out var projectInfoData);
        ...
        {
            _app.Model.GetVersion(out var versionName, out var versionNumber);
    ...
    [TestFixture]
    public class CSiModelTests_Set : CsiSet
    {
        [TestCase("units")]
