...
namespace MPT.CSI.API.Core.Program
{
    ...
    public class CSiModel : CSiApiBase
    {
        ...
        /// </summary>
        /// <returns></returns>
        public void GetPresentUnits(out eForce forceUnits,
            out eLength lengthUnits,
            out eTemperature temperatureUnits)
        {
            forceUnits = 0;
        ...
        /// <exception cref="CSiException"><see cref="CSiApiBase.API_DEFAULT_ERROR_CODE" /></exception>
        /// <exception cref="MPT.CSI.API.Core.Support.CSiException"></exception>
        public void GetProjectInfo(out string[] projectInfoItems,
            out string[] projectInfoData)
        {
            projectInfoItems = new string[0];
            projectInfoData = new string[0];
        ...
        /// <exception cref="CSiException"><see cref="CSiApiBase.API_DEFAULT_ERROR_CODE" /></exception>
        /// <exception cref="MPT.CSI.API.Core.Support.CSiException"></exception>
        public void GetVersion(out string versionName,
