...
// ***********************************************************************
// <copyright file="ILoadStrainUniaxial.cs" company="">
//     Copyright ©  2017
// </copyright>
// <summary></summary>
// ***********************************************************************
...
{
    /// <summary>
    /// Object has a CRUDable axial strain load.
    /// </summary>
    public interface ILoadStrainUniaxial
    {
        /// <summary>
        ...
        void SetLoadStrain(string name,
            string loadPattern,
        ...
        void DeleteLoadStrain(string name,
            string loadPattern,
            eItemType itemType = eItemType.Object);
    }
}
