...
namespace MPT.CSI.API.Core.Program.ModelBehavior.ObjectModel
{
    ...
    public class AreaObject : CSiApiBase, IAreaObject
    {
        ...
        /// <summary>
        /// Retrieves the names of all defined area properties for a given story.
        /// </summary>
        ...
        public string GetNameFromLabel(UniqueLabel label)
        {
            ...
            _callCode = _sapModel.AreaObj.GetNameFromLabel(label.Label, label.Story, ref name);
            if (throwCurrentApiException(_callCode)) { throw new CSiException(API_DEFAULT_ERROR_CODE); }
            ...
            bool isGlobal = true)
        {
            ...
            _callCode = _sapModel.AreaObj.GetTransformationMatrix(nameObject, ref directionCosinesArray, isGlobal);
            if (throwCurrentApiException(_callCode)) { throw new CSiException(API_DEFAULT_ERROR_CODE); }
        ...
        public string[] GetPoints(string name)
        {
            ...
            _callCode = _sapModel.AreaObj.GetPoints(name, ref _numberOfItems, ref points);
            if (throwCurrentApiException(_callCode)) { throw new CSiException(API_DEFAULT_ERROR_CODE); }
        ...
        public string[] GetElement(string name)
        {
            ...
            _callCode = _sapModel.AreaObj.GetElm(name, 
                ref _numberOfItems, 
                ref elementNames);
            if (throwCurrentApiException(_callCode)) { throw new CSiException(API_DEFAULT_ERROR_CODE); }
            ...
            string coordinateSystem = CoordinateSystems.Global)
        {
            ...
            double[] zCoordinates = new double[coordinates.Length];
            ...
            string uniqueName = "")
        {
            ...
            _callCode = _sapModel.AreaObj.AddByPoint(pointNames.Length, ref pointNames, ref name, propertyName, uniqueName);
            if (throwCurrentApiException(_callCode)) { throw new CSiException(API_DEFAULT_ERROR_CODE); }
            ...
            out string[] groupNames)
        {
            ...
            _callCode = _sapModel.AreaObj.GetGroupAssign(objectName,
        ...
        /// <param name="name">The name of an existing area object.</param>
        /// <exception cref="CSiException"><see cref="CSiApiBase.API_DEFAULT_ERROR_CODE" /></exception>
        public bool[] GetSelectedEdge(string name)
        {
            bool[] areEdgesSelected = new bool[0];
            _callCode = _sapModel.AreaObj.GetSelectedEdge(name, ref _numberOfItems, ref areEdgesSelected);
            if (throwCurrentApiException(_callCode)) { throw new CSiException(API_DEFAULT_ERROR_CODE); }

            return areEdgesSelected;
        }
        ...
        public void SetSelectedEdge(string name,
            ...
            bool isEdgeSelected)
        {
            _callCode = _sapModel.AreaObj.SetSelectedEdge(name, edgeNumber, isEdgeSelected);
            if (throwCurrentApiException(_callCode)) { throw new CSiException(API_DEFAULT_ERROR_CODE); }
        }
        #endregion
        ...
        /// <summary>
        /// Assigns the section property to an area object.
        /// </summary>
        ...
        /// <exception cref="CSiException"><see cref="CSiApiBase.API_DEFAULT_ERROR_CODE" /></exception>
        public void GetAllAreas(out string[] areaNames,
            out eAreaDesignOrientation[] designOrientations,
            out int numberOfBoundaryPts,
            out int[] pointDelimiters,
            out string[] pointNames,
            out Coordinate3DCartesian[] coordinates)
        {
            areaNames = new string[0];
            numberOfBoundaryPts = -1;
            pointDelimiters = new int[0];
        ...
        /// <param name="objectName">The name of an existing object.</param>
        /// <exception cref="CSiException"><see cref="CSiApiBase.API_DEFAULT_ERROR_CODE" /></exception>
        public string GetDiaphragm(string objectName)
        {
            string diaphragmName = string.Empty;
            _callCode = _sapModel.AreaObj.GetDiaphragm(objectName, ref diaphragmName);
            if (throwCurrentApiException(_callCode)) { throw new CSiException(API_DEFAULT_ERROR_CODE); }
        ...
        /// </summary>
        /// <param name="objectName">The name of an existing object.</param>
        /// <param name="diaphragmName">The name of an existing diaphragm to be assigned to the specified area object.
        /// If it is "None", no diaphragm will be assigned to the area object.</param>
        /// <exception cref="CSiException"><see cref="CSiApiBase.API_DEFAULT_ERROR_CODE" /></exception>
        public void SetDiaphragm(string objectName,
            string diaphragmName = "None")
        {
            _callCode = _sapModel.AreaObj.SetDiaphragm(objectName, diaphragmName);
            if (throwCurrentApiException(_callCode)) { throw new CSiException(API_DEFAULT_ERROR_CODE); }
        }
        ...
        /// This item applies only when <paramref name="springTypes" /> = <see cref="eSpringType.Link" />.</param>
        /// <param name="coordinateSystems">This is Local (meaning the  object local coordinate system) or the name of a defined coordinate system.
        ...
        /// <param name="coordinateSystem">This is Local (meaning the  object local coordinate system) or the name of a defined coordinate system.
        ...
        /// <param name="name">The name of an existing object.</param>
        /// <exception cref="CSiException"><see cref="CSiApiBase.API_DEFAULT_ERROR_CODE" /></exception>
        public bool GetEdgeConstraint(string name)
        {
        ...
        /// <param name="name">The name of a defined area object.</param>
        /// <exception cref="CSiException"><see cref="CSiApiBase.API_DEFAULT_ERROR_CODE" /></exception>
        public eAreaDesignOrientation GetDesignOrientation(string name)
        {
            eAreaDesignOrientation designOrientation = 0;
        ...
        // LoadGravity
        /// <summary>
        /// Returns the gravity load assignments to objects.
        /// </summary>
        ...
        // LoadPorePressure
        /// <summary>
        /// Returns the pore pressure load assignments to objects.
        /// </summary>
        /// <param name="name">The name of an existing object or group, depending on the value of the <paramref name="itemType" /> item.</param>
        ...
        /// <summary>
        /// Assigns pore pressure loads to objects.
        /// </summary>
        /// <param name="name">The name of an existing object, element or group of objects, depending on the value of <paramref name="itemType" />.</param>
        ...
        /// <summary>
        /// Deletes the pore pressure load assignments to the specified objects for the specified load pattern.
        /// </summary>
        /// <param name="name">The name of an existing object, element or group of objects, depending on the value of <paramref name="itemType" />.</param>
        /// <param name="loadPattern">The name of the load pattern associated with the load.</param>
        /// <param name="itemType">If this item is <see cref="eItemType.Object" />, the assignments are deleted for the object specified by the <paramref name="name" /> item.
        ...
        // LoadStrain
        /// <summary>
        /// Returns the strain load assignments to objects.
        /// </summary>
        /// <param name="name">The name of an existing object, object or group of objects, depending on the value of <paramref name="itemType" />.</param>
        ...
        // LoadSurfacePressure
        /// <summary>
        /// Returns the surface pressure assignments to objects.
        /// </summary>
        /// <param name="name">The name of an existing object, object or group of objects, depending on the value of <paramref name="itemType" />.</param>
        ...
        /// <summary>
        /// Assigns surface pressure loads to objects.
        /// </summary>
        /// <param name="name">The name of an existing object, element or group of objects, depending on the value of <paramref name="itemType" />.</param>
        ...
        /// <summary>
        /// Deletes the surface pressure load assignments to the specified objects for the specified load pattern.
        /// </summary>
        /// <param name="name">The name of an existing object, element or group of objects, depending on the value of <paramref name="itemType" />.</param>
        /// <param name="loadPattern">The name of the load pattern associated with the load.</param>
        /// <param name="itemType">If this item is <see cref="eItemType.Object" />, the assignments are deleted for the object specified by the <paramref name="name" /> item.
        ...
        public void GetLoadTemperature(string name,
            ...
            out eLoadTemperatureType[] temperatureLoadType,
            ...
            eItemType itemType = eItemType.Object)
        {
            ...
            _callCode = _sapModel.AreaObj.GetLoadTemperature(name, ref _numberOfItems, 
        ...
        /// <summary>
        /// Assigns rotational loads to objects.
        /// </summary>
        /// <param name="name">The name of an existing object.</param>
        ...
        /// <summary>
        /// Deletes the rotation load assignments to the specified objects for the specified load pattern.
        /// </summary>
        /// <param name="name">The name of an existing object, element or group of objects, depending on the value of <paramref name="itemType" />.</param>
        /// <param name="loadPattern">The name of the load pattern associated with the load.</param>
        /// <param name="itemType">If this item is <see cref="eItemType.Object" />, the assignments are deleted for the object specified by the <paramref name="name" /> item.
        ...
        public void GetLoadUniform(string name,
            ...
            out eLoadDirection[] directionApplied,
            out double[] uniformLoadValues,
            eItemType itemType = eItemType.Object)
        {
            names = new string[0];
            loadPatterns = new string[0];
            coordinateSystems = new string[0];
            uniformLoadValues = new double[0];
            int[] csiDirectionApplied = new int[0];

            _callCode = _sapModel.AreaObj.GetLoadUniform(name, ref _numberOfItems, 
        ...
        public void GetLoadUniformToFrame(string name,
            ...
            out double[] values,
            out eLoadDirection[] directions,
            out eLoadDistributionType[] distributionTypes,
            out string[] coordinateSystems,
            eItemType itemType = eItemType.Object)
        {
            loadPatterns = new string[0];
            ...
            _callCode = _sapModel.AreaObj.GetLoadUniformToFrame(name, ref _numberOfItems, 
        ...
        public void GetLoadWindPressure(string name,
            out string[] areaNames,
            out string[] loadPatterns,
            out eWindPressureApplication[] windPressureTypes,
            out double[] pressureCoefficients,
            eItemType itemType = eItemType.Object)
        {
            areaNames = new string[0];
            loadPatterns = new string[0];
            pressureCoefficients = new double[0];
            int[] csiWindPressureTypes = new int[0];

            _callCode = _sapModel.AreaObj.GetLoadWindPressure(name, ref _numberOfItems, 
