...
// ***********************************************************************
// <copyright file="INotionalSize.cs" company="">
//     Copyright ©  2017
// </copyright>
// <summary></summary>
// ***********************************************************************
...
namespace MPT.CSI.API.Core.Program.ModelBehavior.ObjectModel
{
    ...
    {
        /// <summary>
        /// Returns the method to determine the notional size of a section for the creep and shrinkage calculations.
        ...
        /// <summary>
        /// Assigns the method to determine the notional size of a section for the creep and shrinkage calculations.
        /// </summary>
        /// <param name="name">The name of an existing section property.</param>
        /// <param name="sizeType">The type to define the notional size of a section.</param>
