...
// ***********************************************************************
// <copyright file="IChangeableMaterialTemperature.cs" company="">
//     Copyright ©  2017
// </copyright>
// <summary></summary>
// ***********************************************************************
...
{
    /// <summary>
    /// Object can set material temperature data.
    /// </summary>
    public interface IChangeableMaterialTemperature
    {
        /// <summary>
        ...
        void SetMaterialTemperature(string name,
            double temperature,
            string patternName,
