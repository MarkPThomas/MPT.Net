...
namespace MPT.CSI.API.Core.Program.ModelBehavior.ObjectModel
{
    ...
    {
        /// <summary>
        /// Deletes all the external results previously provided for all frame objects.
        /// </summary>
        void DeleteAllFrameForces();

        /// <summary>
        /// Deletes all the external results previously provided for a given frame object.
        /// </summary>
        ...
        /// <summary>
        /// Sets the external result forces for a given step of a given external results load case on a frame object.
        /// </summary>
        /// <param name="name">The name of an existing frame object.</param>
        /// <param name="initialCase">The name of an existing external results load case for which external results relevant to the object may have been previously provided.</param>
        ...
        /// <summary>
        /// Sets the external result forces for all input frames and load cases.
        ...
        /// <summary>
        /// Sets the frame stations on a frame object for which user-supplied external analysis results are available.
        /// </summary>
        /// <param name="name">The name of an existing frame object.</param>
        /// <param name="distancesFromIEnd">The distances measured from the I-end of the object to the result location.</param>
