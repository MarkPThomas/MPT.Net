...
// ***********************************************************************
// <copyright file="IAreaEditor.cs" company="">
//     Copyright ©  2017
// </copyright>
// <summary></summary>
// ***********************************************************************
...
{
    /// <summary>
    /// Implements the area editor in the application.
    /// </summary>
    public interface IAreaEditor
    {
        ...
        void ExpandShrink(eAreaOffsetType offsetType,
            double offset);
        ...
        void Merge(ref int numberOfAreas,
            ref string[] areaNames);
