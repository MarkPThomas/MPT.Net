...
namespace MPT.CSI.API.Core.Program.ModelBehavior.AnalysisResult
{
    ...
    public class Results : CSiApiBase, IResults
    {
        ...
        /// <exception cref="MPT.CSI.API.Core.Support.CSiException"><see cref="CSiApiBase.API_DEFAULT_ERROR_CODE" /></exception>
        public void AreaForceShell(string name,
            ...
            out string[] stepTypes,
            out double[] stepNumbers,
            out double[] F11,
            out double[] F22,
            out double[] F12,
            out double[] FMax,
            ...
            out double[] VAngle)
        {
            loadCases = new string[0];
            stepTypes = new string[0];
            stepNumbers = new double[0];
        ...
        public void AreaStressShell(string name,
            ...
            out string[] stepTypes,
            out double[] stepNumbers,
            out Stress[] stressesTop,
            out Stress[] stressesBottom,
            out double[] S13Avg,
            out double[] S23Avg,
            out double[] SMaxAvg,
            out double[] SAngleAvg)
        {
            loadCases = new string[0];
            stepTypes = new string[0];
            stepNumbers = new double[0];
            ...
            S13Avg = new double[0];
            S23Avg = new double[0];
            SMaxAvg = new double[0];
            SAngleAvg = new double[0];
        ...
        public void AreaStressShellLayered(string name,
            ...
            out double[] SAngleAvg,
            out string[] layers,
            out int[] integrationPointNumbers,
            out double[] integrationPointLocations)
        {
            loadCases = new string[0];
            stepTypes = new string[0];
            stepNumbers = new double[0];
            ...
            pointNames = new string[0];
            layers = new string[0];
            integrationPointNumbers = new int[0];
            integrationPointLocations = new double[0];
            S13Avg = new double[0];
            S23Avg = new double[0];
            SMaxAvg = new double[0];
            SAngleAvg = new double[0];
        ...
        public void AssembledJointMass(string massSourceName,
            string name,
            eItemTypeElement itemType,
            out string[] pointElementNames,
            out string[] massSourceNames,
            out Mass[] masses)
        {
            massSourceNames = new string[0];
        ...
        {
#endif
            pointElementNames = new string[0];
        ...
        /// <exception cref="CSiException"><see cref="CSiApiBase.API_DEFAULT_ERROR_CODE" /></exception>
        /// <exception cref="MPT.CSI.API.Core.Support.CSiException"><see cref="CSiApiBase.API_DEFAULT_ERROR_CODE" /></exception>
        public void BaseReaction(out string[] loadCases,
            out string[] stepTypes,
            out double[] stepNumbers,
            ...
            out Coordinate3DCartesian baseReactionCoordinate)
        {
            ...
            baseReactionCoordinate = new Coordinate3DCartesian
            {
                X = gx,
                Y = gy,
                Z = gz
        ...
        /// <exception cref="CSiException"><see cref="CSiApiBase.API_DEFAULT_ERROR_CODE" /></exception>
        /// <exception cref="MPT.CSI.API.Core.Support.CSiException"><see cref="CSiApiBase.API_DEFAULT_ERROR_CODE" /></exception>
        public void BaseReactionWithCentroid(out string[] loadCases,
            out string[] stepTypes,
            out double[] stepNumbers,
            out Reactions[] reactions,
            out Coordinate3DCartesian baseReactionCoordinate,
            out Coordinate3DCartesian[] centroidFxCoordinates,
            out Coordinate3DCartesian[] centroidFyCoordinates,
            out Coordinate3DCartesian[] centroidFzCoordinates)
        {
            loadCases = new string[0];
            stepTypes = new string[0];
            stepNumbers = new double[0];
        ...
        public void FrameForce(string name,
            ...
            out string[] stepTypes,
            out double[] stepNumbers,
            out double[] objectStations,
            out double[] elementStations,
            out Forces[] forces)
        {
            loadCases = new string[0];
            stepTypes = new string[0];
            ...
            elementNames = new string[0];
            objectNames = new string[0];
            objectStations = new double[0];
            elementStations = new double[0];
        ...
        public void JointResponseSpectrum(string name,
            ...
            out eDirection[] directions,
            out double[] damping,
            out double[] percentSpectrumWidening,
            out double[] abscissaValues,
            out double[] ordinateValues)
        {
            loadCases = new string[0];
            stepTypes = new string[0];
            stepNumbers = new double[0];
        ...
        /// <param name="driftsY">The drifts y in the y-direction.</param>
        /// <exception cref="CSiException"><see cref="CSiApiBase.API_DEFAULT_ERROR_CODE" /></exception>
        public void JointDrifts(out string[] storyNames,
            out string[] labels,
            out string[] names,
            out string[] loadCases,
            out string[] stepTypes,
            out double[] stepNumbers,
            out double[] displacementsX,
            out double[] displacementsY,
            out double[] driftsX,
            out double[] driftsY)
        {
            loadCases = new string[0];
            ...
            labels = new string[0];
            names = new string[0];
            displacementsX = new double[0];
            displacementsY = new double[0];
            driftsX = new double[0];
            driftsY = new double[0];
        ...
        public void JointAcceleration(string name,
            ...
            out string[] stepTypes,
            out double[] stepNumbers,
            out Deformations[] accelerations)
        {
            loadCases = new string[0];
            stepTypes = new string[0];
            stepNumbers = new double[0];
        ...
        public void JointDisplacement(string name,
            ...
            out string[] stepTypes,
            out double[] stepNumbers,
            out Deformations[] displacements)
        {
            loadCases = new string[0];
            stepTypes = new string[0];
            stepNumbers = new double[0];
        ...
        /// <exception cref="CSiException"><see cref="CSiApiBase.API_DEFAULT_ERROR_CODE" /></exception>
        /// <exception cref="MPT.CSI.API.Core.Support.CSiException"><see cref="CSiApiBase.API_DEFAULT_ERROR_CODE" /></exception>
        public void ModalLoadParticipationRatios(out string[] loadCases,
            out string[] itemTypes,
            out string[] items,
            out double[] percentStaticLoadParticipationRatio,
            out double[] percentDynamicLoadParticipationRatio)
        {
            loadCases = new string[0];
            itemTypes = new string[0];
            items = new string[0];
            percentStaticLoadParticipationRatio = new double[0];
            percentDynamicLoadParticipationRatio = new double[0];
        ...
        /// <exception cref="CSiException"><see cref="CSiApiBase.API_DEFAULT_ERROR_CODE" /></exception>
        /// <exception cref="MPT.CSI.API.Core.Support.CSiException"><see cref="CSiApiBase.API_DEFAULT_ERROR_CODE" /></exception>
        public void ModalParticipatingMassRatios(out string[] loadCases,
            out string[] stepTypes,
            out double[] stepNumbers,
            out double[] periods,
            out Mass[] massRatios,
            out Mass[] massRatioSums)
        {
            loadCases = new string[0];
            stepTypes = new string[0];
            stepNumbers = new double[0];
        ...
        /// <exception cref="CSiException"><see cref="CSiApiBase.API_DEFAULT_ERROR_CODE" /></exception>
        /// <exception cref="MPT.CSI.API.Core.Support.CSiException"><see cref="CSiApiBase.API_DEFAULT_ERROR_CODE" /></exception>
        public void ModalParticipationFactors(out string[] loadCases,
            out string[] stepTypes,
            out double[] stepNumbers,
            out double[] periods,
            out Mass[] participationFactors,
            out double[] modalMasses,
            out double[] modalStiffnesses)
        {
            loadCases = new string[0];
            stepTypes = new string[0];
            stepNumbers = new double[0];
            periods = new double[0];
            modalMasses = new double[0];
            modalStiffnesses = new double[0];
        ...
        /// <exception cref="CSiException"><see cref="CSiApiBase.API_DEFAULT_ERROR_CODE" /></exception>
        /// <exception cref="MPT.CSI.API.Core.Support.CSiException"><see cref="CSiApiBase.API_DEFAULT_ERROR_CODE" /></exception>
        public void ModalPeriod(out string[] loadCases,
            out string[] stepTypes,
            out double[] stepNumbers,
            out double[] periods,
            out double[] frequencies,
            out double[] circularFrequencies,
            out double[] eigenvalues)
        {
            ...
            circularFrequencies = new double[0];
        ...
        /// <exception cref="CSiException"><see cref="CSiApiBase.API_DEFAULT_ERROR_CODE" /></exception>
        /// <exception cref="MPT.CSI.API.Core.Support.CSiException"><see cref="CSiApiBase.API_DEFAULT_ERROR_CODE" /></exception>
        public void SectionCutAnalysis(out string[] sectionCuts,
            out string[] loadCases,
            out string[] stepTypes,
            out double[] stepNumbers,
            out Loads[] analysisForces)
        {
            loadCases = new string[0];
            stepTypes = new string[0];
            stepNumbers = new double[0];
            sectionCuts = new string[0];
        ...
        /// <exception cref="CSiException"><see cref="CSiApiBase.API_DEFAULT_ERROR_CODE" /></exception>
        /// <exception cref="MPT.CSI.API.Core.Support.CSiException"><see cref="CSiApiBase.API_DEFAULT_ERROR_CODE" /></exception>
        public void SectionCutDesign(out string[] sectionCuts,
            out string[] loadCases,
            out string[] stepTypes,
            out double[] stepNumbers,
            out Forces[] designForces)
        {
            loadCases = new string[0];
            stepTypes = new string[0];
            stepNumbers = new double[0];
        ...
        public void SolidStress(string name,
            ...
            ref Stress[] stresses,
            out double[] SMid,
            out double[] DirectionCosineMax1,
            out double[] DirectionCosineMax2,
            out double[] DirectionCosineMax3,
            out double[] DirectionCosineMid1,
            out double[] DirectionCosineMid2,
            out double[] DirectionCosineMid3,
            out double[] DirectionCosineMin1,
            out double[] DirectionCosineMin2,
            out double[] DirectionCosineMin3)
        {
            double[] S11 = new double[0];
            double[] S22 = new double[0];
            double[] S33 = new double[0];
        ...
        /// <exception cref="CSiException"></exception>
        /// <exception cref="MPT.CSI.API.Core.Support.CSiException"></exception>
        public void PierForce(out string[] storyNames,
            out string[] pierNames,
            out string[] loadCases,
            out eLocationVertical[] locations,
            out Forces[] forces)
        {
            loadCases = new string[0];
            storyNames = new string[0];
            pierNames = new string[0];
        ...
        /// <exception cref="CSiException"></exception>
        /// <exception cref="MPT.CSI.API.Core.Support.CSiException"></exception>
        public void SpandrelForce(out string[] storyNames,
            out string[] spandrelNames,
            out string[] loadCases,
            out eLocationVertical[] locations,
            out Forces[] forces)
        {
        ...
        /// <summary>
        /// Returns the longitudinal stresses for multiple cases/combos at a single stress point in a superstructure section cut in a bridge object. <para/>
        ...
        /// The step label, including the name or number of the stage, the step number within the stage, and the age of the structure for time-dependent load cases.
        ...
        /// <exception cref="CSiException"><see cref="CSiApiBase.API_DEFAULT_ERROR_CODE" /></exception>
        /// <exception cref="MPT.CSI.API.Core.Support.CSiException"></exception>
        public string StepLabel(string loadCase,
            double stepNumber)
        {
        ...
        /// <exception cref="CSiException"></exception>
        /// <exception cref="MPT.CSI.API.Core.Support.CSiException"></exception>
        public void StoryDrifts(out string[] stories,
            out string[] labels,
            out string[] loadCases,
            out string[] stepTypes,
            out double[] stepNumbers,
            out string[] directions,
            out double[] drifts,
            out double[] displacementsX,
            out double[] displacementsY,
            out double[] displacementsZ)
        {
            loadCases = new string[0];
            stepTypes = new string[0];
            stepNumbers = new double[0];
        ...
        /// <exception cref="CSiException"><see cref="CSiApiBase.API_DEFAULT_ERROR_CODE" /></exception>
        /// <exception cref="MPT.CSI.API.Core.Support.CSiException"><see cref="CSiApiBase.API_DEFAULT_ERROR_CODE" /></exception>
        public void BucklingFactor(out string[] loadCases,
            out string[] stepTypes,
            out double[] stepNumbers,
            out double[] bucklingFactors)
        {
            loadCases = new string[0];
            stepTypes = new string[0];
            stepNumbers = new double[0];
            bucklingFactors = new double[0];

            _callCode = _sapModel.Results.BucklingFactor(
                ref _numberOfItems, 
                ref loadCases, 
                ref stepTypes, 
                ref stepNumbers, 
        ...
        public void GeneralizedDisplacement(string name,
            ...
            out double[] stepNumbers,
            out string[] types,
            out double[] generalizedDisplacements)
        {
            names = new string[0];
            loadCases = new string[0];
            stepTypes = new string[0];
            stepNumbers = new double[0];
            types = new string[0];
            generalizedDisplacements = new double[0];

            _callCode = _sapModel.Results.GeneralizedDispl(name, 
                ref _numberOfItems, 
                ref names, 
                ref loadCases, 
                ref stepTypes, 
