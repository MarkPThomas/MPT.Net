...
namespace MPT.CSI.API.Core.Program.ModelBehavior.AnalysisResult
{
    ...
    public interface IResults
    {
        ...
        /// <exception cref="MPT.CSI.API.Core.Support.CSiException"></exception>
        void BaseReaction(out string[] loadCases,
            out string[] stepTypes,
            out double[] stepNumbers,
        ...
        /// <exception cref="MPT.CSI.API.Core.Support.CSiException"></exception>
        void BaseReactionWithCentroid(out string[] loadCases,
            out string[] stepTypes,
            out double[] stepNumbers,
            out Reactions[] reactions,
            out Coordinate3DCartesian baseReactionCoordinate,
        ...
        void JointDrifts(out string[] storyNames,
            out string[] labels,
            out string[] names,
            out string[] loadCases,
            out string[] stepTypes,
        ...
        /// <exception cref="MPT.CSI.API.Core.Support.CSiException"></exception>
        void ModalLoadParticipationRatios(out string[] loadCases,
        ...
        /// <exception cref="MPT.CSI.API.Core.Support.CSiException"></exception>
        void ModalParticipatingMassRatios(out string[] loadCases,
            out string[] stepTypes,
            out double[] stepNumbers,
            out double[] periods,
            out Mass[] massRatios,
        ...
        /// <exception cref="MPT.CSI.API.Core.Support.CSiException"></exception>
        void ModalParticipationFactors(out string[] loadCases,
            out string[] stepTypes,
            out double[] stepNumbers,
            out double[] periods,
        ...
        /// <exception cref="MPT.CSI.API.Core.Support.CSiException"></exception>
        void ModalPeriod(out string[] loadCases,
            out string[] stepTypes,
            out double[] stepNumbers,
            out double[] periods,
        ...
        /// <exception cref="MPT.CSI.API.Core.Support.CSiException"></exception>
        void SectionCutAnalysis(out string[] sectionCuts,
            out string[] loadCases,
            out string[] stepTypes,
            out double[] stepNumbers,
        ...
        /// <exception cref="MPT.CSI.API.Core.Support.CSiException"></exception>
        void SectionCutDesign(out string[] sectionCuts,
            out string[] loadCases,
            out string[] stepTypes,
            out double[] stepNumbers,
        ...
        /// <param name="forces">The internal forces for each result.</param>
        /// <exception cref="MPT.CSI.API.Core.Support.CSiException"></exception>
        void PierForce(out string[] storyNames,
        ...
        /// <param name="forces">The internal forces for each result.</param>
        /// <exception cref="MPT.CSI.API.Core.Support.CSiException"></exception>
        void SpandrelForce(out string[] storyNames,
        ...
        /// <exception cref="MPT.CSI.API.Core.Support.CSiException"></exception>
        void StoryDrifts(out string[] stories,
            out string[] labels,
            out string[] loadCases,
            out string[] stepTypes,
            out double[] stepNumbers,
        ...
        /// <exception cref="MPT.CSI.API.Core.Support.CSiException"></exception>
        void BucklingFactor(out string[] loadCases,
            out string[] stepTypes,
            out double[] stepNumbers,
