...
namespace MPT.CSI.API.Core.Program.ModelBehavior.Definition.Function
{
    ...
    /// </summary>
    /// <seealso cref="MPT.CSI.API.Core.Program.ModelBehavior.Definition.Function.IPowerSpectralDensity" />
    /// <seealso cref="MPT.CSI.API.Core.Support.CSiApiBase" />
    public class PowerSpectralDensity : CSiApiBase, IPowerSpectralDensity
    {
        ...
        /// <summary>
        /// Returns the definition of a power spectral density function from file.
        /// </summary>
        ...
        /// <summary>
        /// Returns the definition of a user defined power spectral density function.
        /// </summary>
        /// <param name="name">The name of a user defined power spectral density function.</param>
        ...
        public void GetUser(string name,
            ...
            ref double[] values)
        {
            _callCode = _sapModel.Func.FuncPSD.GetUser(name, ref _numberOfItems, ref frequencies, ref values);
            if (throwCurrentApiException(_callCode)) { throw new CSiException(API_DEFAULT_ERROR_CODE); }
        }
