...
namespace MPT.CSI.API.Core.Program.ModelBehavior.Definition.LoadCase
{
    ...
    public class TimeHistoryDirectLinear : CSiApiBase, ITimeHistoryDirectLinear
    {
        ...
        /// <param name="functions">The name of the loadfunction associated with each load.</param>
            ...
            out double[] angles)
        {
            ...
            _callCode = _sapModel.LoadCases.DirHistLinear.GetLoads(name, ref _numberOfItems, ref csiLoadTypes, ref loadNames, ref functions, ref scaleFactor, ref timeFactor, ref arrivalTime, ref coordinateSystems, ref angles);
            if (throwCurrentApiException(_callCode)) { throw new CSiException(API_DEFAULT_ERROR_CODE); }
            ...
            double[] angles)
        {
            ...
            _callCode = _sapModel.LoadCases.DirHistLinear.SetLoads(name, loadTypes.Length, ref csiLoadTypes, ref loadNames, ref functions, ref scaleFactor, ref timeFactor, ref arrivalTime, ref coordinateSystems, ref angles);
            if (throwCurrentApiException(_callCode)) { throw new CSiException(API_DEFAULT_ERROR_CODE); }
        }
