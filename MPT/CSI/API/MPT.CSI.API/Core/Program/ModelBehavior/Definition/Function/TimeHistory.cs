...
{
    /// <summary>
    /// Represents the time history function in the application.
    /// </summary>
    /// <seealso cref="MPT.CSI.API.Core.Program.ModelBehavior.Definition.Function.ITimeHistory" />
    /// <seealso cref="MPT.CSI.API.Core.Support.CSiApiBase" />
    public class TimeHistory : CSiApiBase, ITimeHistory
    {
        ...
        /// <summary>
        /// Returns the definition of a time history function from file.
        /// </summary>
        ...
        /// <summary>
        /// Returns the definition of a user defined time history function.
        /// </summary>
        ...
        public void GetUser(string name,
            ...
            ref double[] values)
        {
            _callCode = _sapModel.Func.FuncTH.GetUser(name, ref _numberOfItems, ref times, ref values);
            if (throwCurrentApiException(_callCode)) { throw new CSiException(API_DEFAULT_ERROR_CODE); }
        }
        ...
        public void SetUser(string name,
            ...
            double[] values)
        {
            arraysLengthMatch(nameof(times), times.Length, nameof(values), values.Length);
        ...
        /// <summary>
        /// Returns the definition of a user periodic time history function.
        /// </summary>
        ...
        {
            _callCode = _sapModel.Func.FuncTH.GetUserPeriodic(name, ref numberOfCycles, ref _numberOfItems, ref frequencies, ref values);
            if (throwCurrentApiException(_callCode)) { throw new CSiException(API_DEFAULT_ERROR_CODE); }
        }
        ...
        /// <summary>
        /// Returns the definition of a ramp-type time history function.
        /// </summary>
        ...
        /// <summary>
        /// Returns the definition of a cosine-type time history function.
        /// </summary>
        ...
        /// <summary>
        /// Returns the definition of a sine-type time history function.
        /// </summary>
