...
namespace MPT.CSI.API.Core.Program.ModelBehavior.Definition
{
    ...
    public class MassSource : CSiApiBase, IMassSource
    {
        ...
        /// <summary>
        /// Returns the number of defined mass sources.
        /// </summary>
        ...
        /// <summary>
        /// Deletes an existing mass source.
        ...
        public string[] GetNameList()
        {
            ...
            _callCode = _sapModel.SourceMass.GetNameList(ref _numberOfItems, ref names);
            if (throwCurrentApiException(_callCode)) { throw new CSiException(API_DEFAULT_ERROR_CODE); }
            return names;
        }
        ...
        /// <summary>
        /// Returns the default mass source name.
        /// </summary>
