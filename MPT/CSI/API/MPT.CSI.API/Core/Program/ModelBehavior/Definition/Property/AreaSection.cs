...
namespace MPT.CSI.API.Core.Program.ModelBehavior.Definition.Property
{
    ...
    public class AreaSection : CSiApiBase, IAreaSection
    {
        ...
        /// <summary>
        /// Returns the names of all defined area properties of the specified type.
        /// </summary>
        /// <param name="areaType">The area type to filter the name list by.</param>
        /// <exception cref="CSiException"><see cref="CSiApiBase.API_DEFAULT_ERROR_CODE" /></exception>
        public string[] GetNameList(eAreaSectionType areaType)
        {
            string[] names = new string[0];
        ...
        /// <summary>
        /// Returns the property type for the specified area property.
        /// </summary>
        /// <param name="name">The name of an existing area property.</param>
        /// <exception cref="CSiException"><see cref="CSiApiBase.API_DEFAULT_ERROR_CODE" /></exception>
        ...
        public eAreaSectionType GetType(string name)
        {
            ...
            return (eAreaSectionType)csiAreaPropertyType;
        }


        /// <summary>
        /// Returns area property design parameters for a shell-type area section.
        /// </summary>
        ...
        /// </summary>
        /// <param name="name">The name of an existing shell-type area property that is specified to be a layered shell property.
        ...
        /// <summary>
        /// Returns area property data for an asolid-type area section.
        /// </summary>
        ...
        /// If this is an existing property, that property is modified; otherwise, a new property is added. 
        /// </summary>
        /// <param name="name">The name of an existing asolid-type area property.
        /// If this is an existing property, that property is modified; otherwise, a new property is added. </param>
        /// <param name="nameMaterial">The name of the material property for the area property.</param>
        /// <param name="materialAngle">The material angle. [deg]</param>
        ...
        /// <summary>
        /// Returns area property data for a plane-type area section.
        /// </summary>
        ...
        /// If this is an existing property, that property is modified; otherwise, a new property is added. 
        /// </summary>
        /// <param name="name">The name of an existing plane-type area property.
        /// If this is an existing property, that property is modified; otherwise, a new property is added. </param>
        /// <param name="planeType">Type of the plane.</param>
        /// <param name="nameMaterial">The name of the material property for the area property.</param>
        /// <param name="materialAngle">The material angle. [deg]</param>
        ...
        /// <summary>
        /// Returns area property data for a shell-type area section.
        /// </summary>
        /// <param name="name">The name of an existing shell-type area property.</param>
        ...
        /// If this is an existing property, that property is modified; otherwise, a new property is added.
        /// </summary>
        /// <param name="name">The name of an existing shell-type area property.
        /// If this is an existing property, that property is modified; otherwise, a new property is added. </param>
        /// <param name="shellType">Type of shell.</param>
        /// <param name="includeDrillingDOF">True: Drilling degrees of freedom are included in the element formulation in the analysis model.
        /// This item does not apply when <paramref name="shellType" /> = <see cref="eShellType.PlateThin" />, <see cref="eShellType.PlateThick" /> or <see cref="eShellType.ShellLayered" />.</param>
...
#if BUILD_ETABS2015 || BUILD_ETABS2016 || BUILD_ETABS2017
        /// <summary>
        /// Returns property data for a deck section.
        /// </summary>
        ...
        // ===        
        /// <summary>
        /// Returns property data for a filled deck section.
        /// </summary>
        /// <param name="name">The name of an existing deck property.</param>
        ...
        public void GetDeckFilled(string name,
            out double slabDepth,
            out double ribDepth,
            out double ribWidthTop,
            out double ribWidthBottom,
            out double ribSpacing,
            out double shearThickness,
            out double unitWeight,
            out double shearStudDiameter,
            out double shearStudHeight,
            out double shearStudFu)
        {
            slabDepth = -1;
            ribDepth = -1;
            ribWidthTop = -1;
        ...
        // ===        
        /// <summary>
        /// Returns property data for an unfilled deck section.
        /// </summary>
        /// <param name="name">The name of an existing deck property.</param>
        /// <param name="ribDepth">The rib depth. [L].</param>
        /// <param name="ribWidthTop">The rib width top. [L].</param>
        ...
        // ===        
        /// <summary>
        /// Returns property data for a solid slab deck section.
        /// </summary>
        /// <param name="name">The name of an existing deck property.</param>
        /// <param name="slabDepth">The slab depth. [L].</param>
        /// <param name="shearStudDiameter">The shear stud diameter. [L].</param>
        ...
        // ===
        /// <summary>
        /// Returns property data for a slab section.
        /// </summary>
        ...
        // ===        
        /// <summary>
        /// Returns property data for a ribbed slab section.
        /// </summary>
        /// <param name="name">The name of an existing slab property.</param>
        ...
        /// <param name="stemWidthBottom">The stem with bottom. [L].</param>
        /// <param name="ribSpacing">The rib spacing. [L].</param>
        /// <param name="ribsParallelToAxis">The local axis that the ribs are parallel to.</param>
        /// <exception cref="CSiException"><see cref="CSiApiBase.API_DEFAULT_ERROR_CODE" /></exception>
        public void GetSlabRibbed(string name,
            out double overallDepth,
            out double slabThickness,
            out double stemWidthTop,
            out double stemWidthBottom,
            out double ribSpacing,
            out eLocalAxisPlane ribsParallelToAxis)
        {
            overallDepth = -1;
            slabThickness = -1;
            stemWidthTop = -1;
        ...
        // ===        
        /// <summary>
        /// Returns property data for a waffle slab section.
        /// </summary>
        /// <param name="name">The name of an existing slab property.</param>
        /// <param name="overallDepth">The overall depth. [L].</param>
        /// <param name="slabThickness">The slab thickness. [L].</param>
        ...
        public void GetSlabWaffle(string name,
            ...
            out double stemWidthTop,
            out double stemWidthBottom,
            out double ribSpacingLocal1,
            out double ribSpacingLocal2)
        {
            overallDepth = -1;
            slabThickness = -1;
            stemWidthTop = -1;
        ...
        // ===
        /// <summary>
        /// Returns property data for a wall section.
        /// </summary>
        ...
        public void GetWall(string name,
            out double thickness,
            out eWallPropertyType walltype,
            out eShellType shellType,
            out string nameMaterial,
            out int color,
            out string notes,
        ...
        public void GetWallAutoSelectList(string name,
            ...
            out string startingProperty)
        {
            autoSelectList = new string[0];
            startingProperty = string.Empty;
