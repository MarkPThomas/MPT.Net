...
// ***********************************************************************
// <copyright file="ASCE_7_95.cs" company="">
//     Copyright ©  2017
// </copyright>
// <summary></summary>
// ***********************************************************************
...
namespace MPT.CSI.API.Core.Program.ModelBehavior.Definition.LoadPattern.CodesAutoLoad.Wind
{
    ...
    public class ASCE_7_95 : AutoWindLoad
    {
        #region Initialization        
        /// <summary>
        /// Initializes a new instance of the <see cref="ASCE_7_95" /> class.
        /// </summary>
        /// <param name="seed">The seed.</param>
        public ASCE_7_95(CSiApiSeed seed) : base(seed) { }
        ...
        /// <summary>
        /// Returns auto wind loading parameters for ASCE 7-02.
        /// </summary>
            ...
            ref bool userSpecifiedExposure)
        {
            ...
            _callCode = _sapModel.LoadPatterns.AutoWind.GetASCE795(name,
                            ref csiExposureFrom,
                            ref directionAngle,
                            ref Cpw,
                            ref Cpl,
        ...
        /// <summary>
        /// Assigns auto wind loading parameters for ASCE 7-02.
        /// </summary>
        /// <param name="name">The name of an existing Wind-type load case with an auto wind assignment.</param>
        /// <param name="exposureFrom">The source of the wind exposure.</param>
        /// <param name="directionAngle">The direction angle for the wind load.
        ...
        {
            _callCode = _sapModel.LoadPatterns.AutoWind.SetASCE795(name,
                            (int)exposureFrom,
                            directionAngle,
                            Cpw,
                            Cpl,
