...
namespace MPT.CSI.API.Core.Program.ModelBehavior.Definition.LoadPattern
{
    ...
    public class AutoWind : CSiApiBase, IAutoWind
    {
...
#if !BUILD_ETABS2015 && !BUILD_ETABS2016 && !BUILD_ETABS2017
        /// <summary>
        /// Returns the code name used for auto seismic parameters in Wind-type load patterns.
        ...
        /// <summary>
        /// Returns exposure parameters for auto wind loads determined from extents of rigid diaphragms.
        ...
        /// <summary>
        /// Assigns exposure parameters for auto wind loads determined from extents of rigid diaphragms.
        /// This function does not apply for User-type auto wind loads.
        /// </summary>
        /// <param name="patternName">The name of an existing Wind-type load pattern that has an auto wind load assigned.</param>
