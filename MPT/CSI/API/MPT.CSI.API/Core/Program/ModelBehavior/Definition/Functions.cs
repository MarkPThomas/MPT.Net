...
namespace MPT.CSI.API.Core.Program.ModelBehavior.Definition
{
    ...
    public class Functions : CSiApiBase, IFunctions
    {
        ...
        /// <summary>
        /// Returns the total number of defined loading functions in the model.
        /// </summary>
        ...
        /// <summary>
        /// Returns the function type for the specified function.
        /// </summary>
        ...
        /// <summary>
        /// Returns the time and function values for any defined function.
        /// </summary>
        /// <param name="name">The name of an existing function.</param>
