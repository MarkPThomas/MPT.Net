...
#region Methods: Public
        ...
        /// <inheritdoc />
        /// <summary>
        /// Returns the total number of defined load cases in the model of a specified load case type.
        /// </summary>
        ...
        public string[] GetNameList()
        {
            ...
            _callCode = _sapModel.LoadCases.GetNameList(ref _numberOfItems, ref names);
            if (throwCurrentApiException(_callCode)) { throw new CSiException(API_DEFAULT_ERROR_CODE); }
        ...
        /// <exception cref="CSiException"><see cref="CSiApiBase.API_DEFAULT_ERROR_CODE" /></exception>
        public string[] GetNameList(eLoadCaseType caseType)
        {
            string[] names = new string[0];
            _callCode = _sapModel.LoadCases.GetNameList(ref _numberOfItems, ref names, 
        ...
        /// </summary>
        /// <param name="nameLoadCase">The name of an existing load case.</param>
        /// <param name="designTypeOption">This is one of the following options for <paramref name="designType" />.</param>
