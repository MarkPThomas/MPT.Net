...
namespace MPT.CSI.API.Core.Program.ModelBehavior.Definition
{
    ...
    public class Groups : CSiApiBase, IGroups
    {
        ...
        public string[] GetNameList()
        {
            ...
            _callCode = _sapModel.GroupDef.GetNameList(ref _numberOfItems, ref names);
        ...
        public void GetGroup(string name,
            out int color,
            out bool specifiedForSelection,
            out bool specifiedForSectionCutDefinition,
            out bool specifiedForSteelDesign,
            out bool specifiedForConcreteDesign,
            out bool specifiedForAluminumDesign,
            out bool specifiedForColdFormedDesign,
            out bool specifiedForStaticNLActiveStage,
            out bool specifiedForBridgeResponseOutput,
            out bool specifiedForAutoSeismicOutput,
            out bool specifiedForAutoWindOutput,
            out bool specifiedForMassAndWeight)
        {
            color = -1;
            specifiedForSelection = false;
        ...
        public void GetGroup(string name,
            ...
            out bool specifiedForAutoWindOutput,
            out bool specifiedForMassAndWeight,
            out bool specifiedForSteelJoistDesign,
            out bool specifiedForWallDesign,
            out bool specifiedForBasePlateDesign,
            out bool specifiedForConnectionDesign)
        {
            color = -1;
            specifiedForSelection = false;
            specifiedForSectionCutDefinition = false;
        ...
        private static bool keywordIsReserved(string parameter)
        {
            return String.Compare(parameter, All, StringComparison.Ordinal) == 0;
        }
