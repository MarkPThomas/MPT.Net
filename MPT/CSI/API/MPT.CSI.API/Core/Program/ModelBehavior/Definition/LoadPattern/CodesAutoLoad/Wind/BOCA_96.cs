...
namespace MPT.CSI.API.Core.Program.ModelBehavior.Definition.LoadPattern.CodesAutoLoad.Wind
{
    ...
    public class BOCA_96 : AutoWindLoad
    {
        ...
        /// <summary>
        /// Returns auto wind loading parameters for BOCA 96.
        /// </summary>
        ...
        /// <param name="userSpecifiedGust">True: Gust factor is user defined.
        /// Else, gust factor is determined from the code specified values.</param>
            ...
            ref bool userSpecifiedExposure)
        {
            ...
            _callCode = _sapModel.LoadPatterns.AutoWind.GetBOCA96(name,
                            ref csiExposureFrom,
                            ref directionAngle,
                            ref Cpw,
                            ref Cpl,
        ...
        /// <summary>
        /// Assigns auto wind loading parameters for BOCA 96.
        /// </summary>
        /// <param name="name">The name of an existing Wind-type load case with an auto wind assignment.</param>
        /// <param name="exposureFrom">The source of the wind exposure.</param>
        /// <param name="directionAngle">The direction angle for the wind load.
        ...
        {
            _callCode = _sapModel.LoadPatterns.AutoWind.SetBOCA96(name,
                            (int)exposureFrom,
                            directionAngle,
                            Cpw,
                            Cpl,
