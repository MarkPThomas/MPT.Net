...
namespace MPT.CSI.API.Core.Program.ModelBehavior.Definition.LoadPattern
{
    ...
    /// </summary>
    /// <seealso cref="T:MPT.CSI.API.Core.Program.ModelBehavior.Definition.LoadPattern.IAutoSeismic" />
    ...
    public class AutoSeismic : CSiApiBase, IAutoSeismic
    {
...
#if !BUILD_ETABS2015 && !BUILD_ETABS2016 && !BUILD_ETABS2017
        /// <summary>
        /// Returns the code name used for auto seismic parameters in Quake-type load patterns.
        ...
        /// <summary>
        /// Sets the auto seismic loading type for the specified load pattern to None.
        /// </summary>
        /// <param name="name">The name of an existing Quake-type load pattern.</param>
        /// <exception cref="CSiException"><see cref="CSiApiBase.API_DEFAULT_ERROR_CODE" /></exception>
...
#if !BUILD_ETABS2015 && !BUILD_ETABS2016 && !BUILD_ETABS2017
        /// <summary>
        /// Returns diaphragm eccentricity overrides for auto seismic loads.
        ...
        /// <summary>
        /// Assigns diaphragm eccentricity overrides for auto seismic loads.
        /// This function does not apply for User Load type auto seismic loads.
        /// </summary>
        /// <param name="patternName">The name of an existing Quake-type load pattern that has an auto seismic load assigned.</param>
