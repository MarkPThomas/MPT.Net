...
#region Methods: Interface
        ...
        public string[] GetNameList()
        {
            ...
            _callCode = _sapModel.GridSys.GetNameList(ref _numberOfItems, ref names);
            if (throwCurrentApiException(_callCode)) { throw new CSiException(API_DEFAULT_ERROR_CODE); }
        ...
        {
            directionCosines = new double[0];
            _callCode = _sapModel.GridSys.GetTransformationMatrix(nameObject, ref directionCosines);
            if (throwCurrentApiException(_callCode)) { throw new CSiException(API_DEFAULT_ERROR_CODE); }
        }
        ...
        public DirectionCosines GetTransformationMatrix(string nameObject)
        {
            ...
            _callCode = _sapModel.GridSys.GetTransformationMatrix(nameObject, ref directionCosinesArray);
            if (throwCurrentApiException(_callCode)) { throw new CSiException(API_DEFAULT_ERROR_CODE); }
