...
namespace MPT.CSI.API.Core.Program.ModelBehavior.Definition.LoadCase
{
    ...
    public class StaticNonlinearStaged : CSiApiBase, IStaticNonlinearStaged
    {
        ...
        /// This is blank, None, or the name of an existing analysis case. <para />
        ...
        /// This is the name of an existing mass source or a blank string. <para />
        ...
        /// <inheritdoc />
        /// <summary>
        /// Returns the material nonlinearity options for the specified load case.
        /// </summary>
        ...
        public void GetMaterialNonlinearity(string name,
            out bool considerTimeDependent)
        {
            considerTimeDependent = false;
        ...
        /// <inheritdoc />
        /// <summary>
        /// Sets the material nonlinearity options for the specified load case.
        /// </summary>
        /// <param name="name">The name of an existing static nonlinear staged analysis case.</param>
        /// <param name="considerTimeDependent">True: Any specified time dependent material properties are considered in the analysis.</param>
        /// <exception cref="CSiException"><see cref="CSiApiBase.API_DEFAULT_ERROR_CODE" /></exception>
        public void SetMaterialNonlinearity(string name,
            bool considerTimeDependent)
        {
        ...
        public void GetResultsSaved(string name,
            out eStageSavedOption stageSavedOption,
            out int minStepsForInstantanousLoad,
            out int minStepsForTimeDependentItems)
        {
            minStepsForInstantanousLoad = -1;
            minStepsForTimeDependentItems = -1;

            int csiStageSavedOption = 0;

            _callCode = _sapModel.LoadCases.StaticNonlinearStaged.GetResultsSaved(name, 
                ref csiStageSavedOption, 
                ref minStepsForInstantanousLoad, 
                ref minStepsForTimeDependentItems);
            if (throwCurrentApiException(_callCode)) { throw new CSiException(API_DEFAULT_ERROR_CODE); }
        ...
        /// <summary>
        /// Returns stage data for the specified stage in the specified load case.
        /// </summary>
            ...
            double[] scaleFactors)
        {
            ...
            string[] csiObjectTypes = new string[operations.Length];
        ...
        /// <summary>
        /// Returns the stage definition data for the specified load case.
        /// </summary>
        /// <param name="name">The name of an existing static nonlinear staged load case.</param>
        ...
        public void GetStageData(string name,
            int stage,
            out eStageOperations[] operations,
            out eObjectType[] objectTypes,
            out string[] nameObjects,
            out double[] ages,
            out string[] loadOrObjectTypes,
            out string[] loadOrObjectNames,
            out double[] scaleFactors)
        {
            nameObjects = new string[0];
            ages = new double[0];
            loadOrObjectTypes = new string[0];
            loadOrObjectNames = new string[0];
        ...
        public void GetStageDefinitions(string name,
            out double[] duration,
            out bool[] outputIsToBeSaved,
            out string[] nameOutput,
            out string[] comment)
        {
            duration = new double[0];
            outputIsToBeSaved = new bool[0];
            nameOutput = new string[0];
            comment = new string[0];

            _callCode = _sapModel.LoadCases.StaticNonlinearStaged.GetStageDefinitions_2(name, 
                ref _numberOfItems, 
                ref duration, 
                ref outputIsToBeSaved, 
                ref nameOutput, 
                ref comment);
            if (throwCurrentApiException(_callCode)) { throw new CSiException(API_DEFAULT_ERROR_CODE); }
        }
