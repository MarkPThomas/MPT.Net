...
namespace MPT.CSI.API.Core.Program.ModelBehavior.Definition.Function.CodesResponseSpectrum
{
    ...
    public class NBCC_2005 : ResponseSpectrumFunction
    {
        ...
        protected NBCC_2005(CSiApiSeed seed) : base(seed) { }
        #endregion

        #region Methods: Public
        /// <summary>
        /// Returns the definition of an NBCC2005 response spectrum function.
        /// </summary>
