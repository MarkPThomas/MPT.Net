...
namespace MPT.CSI.API.Core.Program.ModelBehavior.Definition
{
    ...
    public class GeneralizedDisplacements : CSiApiBase, IGeneralizedDisplacements
    {
        ...
        /// <summary>
        /// Returns the total number of defined generalized displacements in the model.
        /// </summary>
        ...
        /// <summary>
        /// Returns the total number of point objects included in a specified generalized displacement.
        /// </summary>
        /// <param name="name">The name of an existing generalized displacement.</param>
        /// <exception cref="CSiException"><see cref="CSiApiBase.API_DEFAULT_ERROR_CODE" /></exception>
        public int CountPoint(string name)
        {
            int count = -1;
        ...
        /// <summary>
        /// Deletes one point object from a generalized displacement definition.
        /// </summary>
        ...
        // === Get/Set
        /// <summary>
        /// Returns the point objects and their scale factors from a generalized displacement definition.
        /// </summary>
        /// <param name="name">The name of an existing generalized displacement.</param>
        ...
        /// <summary>
        /// Adds a point object and its scale factors to a generalized displacement definition. , or, i
        ...
        /// <summary>
        /// Returns the generalized displacement type.
        /// </summary>
        /// <param name="name">The name of an existing generalized displacement.</param>
        /// <exception cref="CSiException"><see cref="CSiApiBase.API_DEFAULT_ERROR_CODE" /></exception>
        public eGeneralizedDisplacementType GetTypeGeneralizedDisplacement(string name)
        {
            int csiType = 0;
            ...
            return (eGeneralizedDisplacementType)csiType;
        }

        /// <summary>
        /// Sets the generalized displacement type.
        /// </summary>
        /// <param name="name">The name of an existing generalized displacement.</param>
        /// <param name="type">The generalized displacement type.</param>
        /// <exception cref="CSiException"><see cref="CSiApiBase.API_DEFAULT_ERROR_CODE" /></exception>
