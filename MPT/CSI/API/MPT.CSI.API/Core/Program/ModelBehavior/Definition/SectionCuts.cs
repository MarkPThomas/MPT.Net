...
#region Methods: Public
        ...
        public string[] GetNameList()
        {
            ...
            _callCode = _sapModel.SectCut. GetNameList(ref _numberOfItems, ref names);
            if (throwCurrentApiException(_callCode)) { throw new CSiException(API_DEFAULT_ERROR_CODE); }
            return names;
        }
        ...
        /// <param name="nameSectionCut">Name of an existing section cut.</param>
        /// <exception cref="CSiException"><see cref="CSiApiBase.API_DEFAULT_ERROR_CODE" /></exception>
        public double GetLocalAxesAngleDesign(string nameSectionCut)
        {
        ...
        /// Location depends on the section cut type, with 1 = Positive3, Top, Right, and 2 = Negative3, Bottom, Left for Analysis, Wall, or Spandrel/Slab.
        /// </summary>
        /// <param name="nameSectionCut">The name of an existing section cut.</param>
        /// <exception cref="CSiException"><see cref="CSiApiBase.API_DEFAULT_ERROR_CODE" /></exception>
        public int GetResultsSide(string nameSectionCut)
        {
