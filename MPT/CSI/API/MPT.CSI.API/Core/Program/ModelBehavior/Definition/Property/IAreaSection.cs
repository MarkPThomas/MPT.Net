namespace MPT.CSI.API.Core.Program.ModelBehavior.Definition.Property
{
        ...
        IObservableAreaModifiers, IChangeableAreaModifiers
    {
        ...
        eAreaSectionType GetType(string name);
        ...
        string[] GetNameList(eAreaSectionType areaType);
        ...
        /// This item does not apply when <paramout name="shellType"/> is <see cref="eShellType.ShellLayered"/>.</param>
