...
namespace MPT.CSI.API.Core.Program.ModelBehavior.Definition.LoadCase
{
    ...
    public class MovingLoad : CSiApiBase, IMovingLoad
    {
        ...
        /// <summary>
        /// Returns the lanes loaded data for a specified load assignment number in a specified load case.
        /// </summary>
        /// <param name="name">The name of an existing moving load case.</param>
        ...
        /// <summary>
        /// Sets the lanes loaded data for a specified load assignment number in a specified load case.
        /// </summary>
        /// <param name="name">The name of an existing moving load case.</param>
        /// <param name="loadNumber">The load assignment number.</param>
        /// <param name="nameLanes">The name of each lane loaded for the specified load assignment number.</param>
        ...
        /// <summary>
        /// Returns the directional factors for the specified load case.
        /// </summary>
        /// <param name="name">The name of an existing moving load case.</param>
        ...
        /// <summary>
        /// Sets the directional factors for the specified load case.
        ...
        /// <summary>
        /// Returns the multilane scale factor data for the specified load case.
        /// </summary>
        /// <param name="name">The name of an existing moving load case.</param>
        ...
        /// <summary>
        /// Sets the multilane scale factor data for the specified load case.
        /// </summary>
        /// <param name="name">The name of an existing moving load case.</param>
