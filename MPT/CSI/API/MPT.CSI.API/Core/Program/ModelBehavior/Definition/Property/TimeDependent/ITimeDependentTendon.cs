...
namespace MPT.CSI.API.Core.Program.ModelBehavior.Definition.Property.TimeDependent
{
    ...
    public interface ITimeDependentTendon
    {
        ...
        /// <summary>
        /// Returns the scale factors for the time-dependent material property data for tendon materials.
        ...
        /// <summary>
        /// Sets scale factors for the time-dependent material property data for tendon materials.
