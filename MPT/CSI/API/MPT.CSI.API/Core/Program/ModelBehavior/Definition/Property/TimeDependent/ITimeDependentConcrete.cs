...
namespace MPT.CSI.API.Core.Program.ModelBehavior.Definition.Property.TimeDependent
{
    ...
    public interface ITimeDependentConcrete
    {
        ...
        /// <summary>
        /// Returns the scale factors for the time-dependent material property data for concrete materials.
        /// </summary>
        ...
        /// <summary>
        /// Sets scale factors for the time-dependent material property data for concrete materials.
