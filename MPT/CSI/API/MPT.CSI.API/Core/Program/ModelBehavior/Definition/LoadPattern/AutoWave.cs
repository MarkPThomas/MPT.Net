...
namespace MPT.CSI.API.Core.Program.ModelBehavior.Definition.LoadPattern
{
    ...
    public class AutoWave : CSiApiBase, IAutoWave
    {
        ...
        /// <summary>
        /// Returns the code name used for auto wave parameters in Wave-type load patterns.
        ...
        /// <summary>
        /// Sets the auto seastate loading type for the specified load pattern to None.
        /// </summary>
