...
// ***********************************************************************
// <copyright file="Superstructure.cs" company="">
//     Copyright ©  2017
// </copyright>
// <summary></summary>
// ***********************************************************************
...
namespace MPT.CSI.API.Core.Program.ModelBehavior.BridgeAdvanced
{
    ...
    public class Superstructure : CSiApiBase, ISuperstructure
    {
...
#region Methods: Public        
        ...
        /// <summary>
        /// Returns location and material information about a single stress point at a superstructure section cut in a bridge object. <para/>
        ...
        /// <summary>
        /// Returns the number of stress points at the specified superstructure section cut.<para/>
        /// If the bridge object is not currently linked to existing objects in the model, an error is returned.
        ...
        /// <summary>
        /// Returns location and orientation information about a single superstructure section cut in a bridge object. <para/>
        /// If the bridge object is not currently linked to existing objects in the model, an error is returned.
        /// TODO: Handle this
        /// </summary>
        /// <param name="name">The name of an existing bridge object.</param>
        ...
        /// <summary>
        /// Returns the number of superstructure section cuts that are available for getting analysis results and performing design.<para/>
        /// If the bridge object is not currently linked to existing objects in the model, an error is returned.
        /// TODO: Handle?
        /// </summary>
        /// <param name="name">The name of an existing bridge object.</param>
