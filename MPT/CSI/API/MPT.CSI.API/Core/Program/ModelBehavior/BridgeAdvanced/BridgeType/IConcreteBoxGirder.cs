...
// ***********************************************************************
// <copyright file="IConcreteBoxGirder.cs" company="">
//     Copyright ©  2017
// </copyright>
// <summary></summary>
// ***********************************************************************
...
{
    /// <summary>
    /// Implements the concrete box girder bridge superstructure in the application.
    /// </summary>
    public interface IConcreteBoxGirder
    {
        #region Methods: Public

        /// <summary>
        /// Returns the number of stress points at the specified web of the specified superstructure section cut.<para/>
        ...
        void CountSuperstructureCutWebStressPoint(string name,
            int cutIndex,
            int webIndex,
            ref int count);

        /// <summary>
        /// Returns section properties for the region above or below a given Y coordinate value at a single superstructure section cut in a bridge object. <para/>
        ...
        void GetSuperstructureCutSectionPropertiesAtY(string name,
            int cutIndex,
            double yCoordinate,
            bool isAboveY,
        ...
        /// <summary>
        /// Returns an individual section property at a single superstructure section cut in a bridge object.<para/>
        ...
        void GetSuperstructureCutSectionValues(string name,
            int cutIndex,
            eSectionCutItem cutSectionItem,
            ref double sectionCutValue);

        /// <summary>
        /// Returns information about the box girder slab thicknesses at a given horizontal location across the box girder section.<para/>
        /// If the bridge object is not currently linked to existing objects in the model, an error is returned.
        /// TODO: Handle this.
        /// </summary>
        /// <param name="name">The name of an existing bridge object.</param>
        ...
        /// This item is returned as zero when <paramref name="status"/> = <see cref="eCutStatus.NoCut"/> or <see cref="eCutStatus.SectionAndInteriorCellCut"/>.</param>
        void GetSuperstructureCutSlabCoordinatesAtX(string name,
            int cutIndex,
            double xCoordinate,
        ...
        /// <summary>
        /// Returns the name of a single tendon object, giving access to tendon assignments, tendon section, and material property. <para/>
        /// If the bridge object is not currently linked to existing objects in the model, an error is returned.
        /// </summary>
        /// <param name="name">The name of an existing bridge object.</param>
        /// <param name="cutIndex">The index number of the section cut in this bridge object. <para/>
        ...
        void GetSuperstructureCutTendonNames(string name,
            int cutIndex,
            int tendonIndex,
        ...
        /// <summary>
        /// Returns an individual section property for a single tendon at a single superstructure section cut in a bridge object. <para/>
        /// These properties are calculated for the section before skew, grade, and superstructure elevation are applied. <para/>
        /// Coordinate values are measured from the lower-left corner of the section bounding-box. <para/>
        /// X is positive to the right when looking upstation, and Y is positive upward.<para/>
        /// If the bridge object is not currently linked to existing objects in the model, an error is returned.
        ...
        void GetSuperstructureCutTendonValues(string name,
            int cutIndex,
            int tendonIndex,
        ...
        /// <summary>
        /// Returns information about the box girder web thicknesses at a given elevation in the box girder section.<para/>
        /// If the bridge object is not currently linked to existing objects in the model, an error is returned.
        /// TODO: Handle
        /// </summary>
        /// <param name="name">The name of an existing bridge object.</param>
        ...
        /// If the web is not cut by a horizontal line at the specified Y coordinate, this value is returned as zero.</param>
        void GetSuperstructureCutWebCoordinatesAtY(string name,
            int cutIndex,
            double yCoordinate,
            ref bool[] webIsCut,
        ...
        /// <summary>
        /// Returns location and material information about a single stress point in a web at a superstructure section cut in a bridge object. <para/>
        ...
        void GetSuperstructureCutWebStressPoint(string name,
            int cutIndex,
            int webIndex,
            int pointIndex,
        ...
        /// <summary>
        /// Returns an individual section property for a single web at a single superstructure section cut in a bridge object. <para/>
        /// These properties are calculated for the section before skew, grade, and superstructure elevation are applied. <para/>
        ...
        void GetSuperstructureCutWebValues(string name,
            int cutIndex,
            int webIndex,
