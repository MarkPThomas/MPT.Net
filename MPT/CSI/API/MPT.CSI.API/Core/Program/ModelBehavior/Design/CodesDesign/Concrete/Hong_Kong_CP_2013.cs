...
// ***********************************************************************
// <copyright file="Hong_Kong_CP_2013.cs" company="">
//     Copyright ©  2017
// </copyright>
// <summary></summary>
// ***********************************************************************
...
namespace MPT.CSI.API.Core.Program.ModelBehavior.Design.CodesDesign.Concrete
{
    ...
    public class Hong_Kong_CP_2013 : ConcreteCode
    {
        ...
        {
            _callCode = _sapModel.DesignConcrete.Hong_Kong_CP_2013.SetOverwrite(name, 
                            (int)item, value, 
