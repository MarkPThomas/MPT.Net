...
// ***********************************************************************
// <copyright file="AS_3600_09.cs" company="">
//     Copyright ©  2017
// </copyright>
// <summary></summary>
// ***********************************************************************
...
{
    /// <summary>
    /// Concrete design code <see cref="AS_3600_09" />.
    /// </summary>
    /// <seealso cref="MPT.CSI.API.Core.Program.ModelBehavior.Design.CodesDesign.Concrete.ConcreteCode" />
    /// <seealso cref="ConcreteCode" />
    public class AS_3600_09 : ConcreteCode
    {
#region Initialization        
        /// <summary>
        /// Initializes a new instance of the <see cref="AS_3600_09" /> class.
        /// </summary>
        /// <param name="seed">The seed.</param>
        public AS_3600_09(CSiApiSeed seed) : base(seed) { }
...
#region Methods: Public
        ...
        {
            _callCode = _sapModel.DesignConcrete.AS_3600_09.GetOverwrite(name, (int)item, ref value, ref programDetermined);
        ...
        {
            _callCode = _sapModel.DesignConcrete.AS_3600_09.SetOverwrite(name, 
                            (int)item, value, 
        ...
        public void GetPreference(ePreferences_AS_3600_09 item,
            ref double value)
        {
            _callCode = _sapModel.DesignConcrete.AS_3600_09.GetPreference((int)item, ref value);
            if (throwCurrentApiException(_callCode)) { throw new CSiException(API_DEFAULT_ERROR_CODE); }
        }
        ...
        public void SetPreference(ePreferences_AS_3600_09 item,
            double value)
        {
            _callCode = _sapModel.DesignConcrete.AS_3600_09.SetPreference((int)item, value);
            if (throwCurrentApiException(_callCode)) { throw new CSiException(API_DEFAULT_ERROR_CODE); }
        }
#endregion
    }
