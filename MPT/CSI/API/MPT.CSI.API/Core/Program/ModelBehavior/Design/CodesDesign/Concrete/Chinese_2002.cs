...
namespace MPT.CSI.API.Core.Program.ModelBehavior.Design.CodesDesign.Concrete
{
    ...
    public class Chinese_2002 : ConcreteCode
    {
        ...
        {
            _callCode = _sapModel.DesignConcrete.Chinese_2002.GetOverwrite(name, (int)item, ref value, ref programDetermined);
        ...
        {
            _callCode = _sapModel.DesignConcrete.Chinese_2002.SetOverwrite(name, 
                            (int)item, value, 
        ...
        public void GetPreference(int item,
            ref double value)
        {
            _callCode = _sapModel.DesignConcrete.Chinese_2002.GetPreference((int)item, ref value);
            if (throwCurrentApiException(_callCode)) { throw new CSiException(API_DEFAULT_ERROR_CODE); }
        }
        ...
        public void SetPreference(int item,
            double value)
        {
            _callCode = _sapModel.DesignConcrete.Chinese_2002.SetPreference((int)item, value);
            if (throwCurrentApiException(_callCode)) { throw new CSiException(API_DEFAULT_ERROR_CODE); }
        }
#endregion
    }
