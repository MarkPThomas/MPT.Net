...
// ***********************************************************************
// <copyright file="AASHTO_LRFD_2012.cs" company="">
//     Copyright ©  2017
// </copyright>
// <summary></summary>
// ***********************************************************************
...
{
    /// <summary>
    /// Concrete design code AASHTO_LRFD_2012.
    /// </summary>
    /// <seealso cref="ConcreteCode" />
    public class AASHTO_LRFD_2012 : ConcreteCode
    {
#region Initialization        
        /// <summary>
        /// Initializes a new instance of the <see cref="AASHTO_LRFD_2012"/> class.
        /// </summary>
        /// <param name="seed">The seed.</param>
        public AASHTO_LRFD_2012(CSiApiSeed seed) : base(seed) { }
...
#region Methods: Public
        ...
        {
            _callCode = _sapModel.DesignConcrete.AASHTO_Concrete_12.GetOverwrite(name, (int)item, ref value, ref programDetermined);
        ...
        {
            _callCode = _sapModel.DesignConcrete.AASHTO_Concrete_12.SetOverwrite(name, 
                            (int)item, value, 
        ...
        public void GetPreference(ePreferences_AASHTO_LRFD_2012 item,
            ref double value)
        {
            _callCode = _sapModel.DesignConcrete.AASHTO_Concrete_12.GetPreference((int)item, ref value);
            if (throwCurrentApiException(_callCode)) { throw new CSiException(API_DEFAULT_ERROR_CODE); }
        }
        ...
        public void SetPreference(ePreferences_AASHTO_LRFD_2012 item,
            double value)
        {
            _callCode = _sapModel.DesignConcrete.AASHTO_Concrete_12.SetPreference((int)item, value);
            if (throwCurrentApiException(_callCode)) { throw new CSiException(API_DEFAULT_ERROR_CODE); }
        }
#endregion
    }
