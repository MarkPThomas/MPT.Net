...
namespace MPT.CSI.API.Core.Program.ModelBehavior.Design.CodesDesign.Concrete
{
    ...
    public class Chinese_2010 : ConcreteCode
    {
        ...
        {
            _callCode = _sapModel.DesignConcrete.Chinese_2010.GetOverwrite(name, (int)item, ref value, ref programDetermined);
        ...
        {
            _callCode = _sapModel.DesignConcrete.Chinese_2010.SetOverwrite(name, 
                            (int)item, value, 
        ...
        public void GetPreference(ePreferences_Chinese_2010 item,
            ref double value)
        {
            _callCode = _sapModel.DesignConcrete.Chinese_2010.GetPreference((int)item, ref value);
            if (throwCurrentApiException(_callCode)) { throw new CSiException(API_DEFAULT_ERROR_CODE); }
        }
        ...
        public void SetPreference(ePreferences_Chinese_2010 item,
            double value)
        {
            _callCode = _sapModel.DesignConcrete.Chinese_2010.SetPreference((int)item, value);
            if (throwCurrentApiException(_callCode)) { throw new CSiException(API_DEFAULT_ERROR_CODE); }
        }
#endregion
    }
