...
// ***********************************************************************
// <copyright file="Indian_IS_456_2000.cs" company="">
//     Copyright ©  2017
// </copyright>
// <summary></summary>
// ***********************************************************************
...
{
    /// <summary>
    /// Concrete design code <see cref="Indian_IS_456_2000" />.
    /// </summary>
    /// <seealso cref="MPT.CSI.API.Core.Program.ModelBehavior.Design.CodesDesign.Concrete.ConcreteCode" />
    /// <seealso cref="ConcreteCode" />
    public class Indian_IS_456_2000 : ConcreteCode
    {
        #region Initialization        
        /// <summary>
        /// Initializes a new instance of the <see cref="Indian_IS_456_2000" /> class.
        /// </summary>
        /// <param name="seed">The seed.</param>
        public Indian_IS_456_2000(CSiApiSeed seed) : base(seed) { }
        ...
        /// <exception cref="CSiException"><see cref="CSiApiBase.API_DEFAULT_ERROR_CODE" /></exception>
        public void GetPreference(ePreferences_Indian_IS_456_2000 item,
            ref double value)
        {
            _callCode = _sapModel.DesignConcrete.Indian_IS_456_2000.GetPreference((int)item, ref value);
            if (throwCurrentApiException(_callCode)) { throw new CSiException(API_DEFAULT_ERROR_CODE); }
        }
        ...
        /// <param name="value">The value of the considered preference item.</param>
        /// <exception cref="CSiException"><see cref="CSiApiBase.API_DEFAULT_ERROR_CODE" /></exception>
        public void SetPreference(ePreferences_Indian_IS_456_2000 item,
            double value)
        {
            _callCode = _sapModel.DesignConcrete.Indian_IS_456_2000.SetPreference((int)item, value);
            if (throwCurrentApiException(_callCode)) { throw new CSiException(API_DEFAULT_ERROR_CODE); }
        }
#endregion
    }
