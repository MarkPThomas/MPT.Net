...
// ***********************************************************************
// <copyright file="AS_4100_1998.cs" company="">
//     Copyright ©  2017
// </copyright>
// <summary></summary>
// ***********************************************************************
...
{
    /// <summary>
    /// Steel design code <see cref="AS_4100_1998" />.
    /// </summary>
    /// <seealso cref="MPT.CSI.API.Core.Program.ModelBehavior.Design.CodesDesign.Steel.SteelCode" />
    /// <seealso cref="SteelCode" />
    public class AS_4100_1998 : SteelCode
    {
        #region Initialization

        /// <summary>
        /// Initializes a new instance of the <see cref="AS_4100_1998" /> class.
        /// </summary>
        /// <param name="seed">The seed.</param>
        public AS_4100_1998(CSiApiSeed seed) : base(seed)
        {
        }
        ...
        {
            _callCode = _sapModel.DesignSteel.Australian_AS4100_98.GetOverwrite(name, (int) item, ref value,
        ...
        {
            _callCode = _sapModel.DesignSteel.Australian_AS4100_98.SetOverwrite(name, 
                            (int) item, value,
        ...
        public void GetPreference(ePreferences_AS_4100_1998 item,
            ref double value)
        {
            _callCode = _sapModel.DesignSteel.Australian_AS4100_98.GetPreference((int) item, ref value);
            if (throwCurrentApiException(_callCode))
            {
                throw new CSiException(API_DEFAULT_ERROR_CODE);
            }
        ...
        public void SetPreference(ePreferences_AS_4100_1998 item,
            double value)
        {
            _callCode = _sapModel.DesignSteel.Australian_AS4100_98.SetPreference((int) item, value);
            if (throwCurrentApiException(_callCode))
            {
                throw new CSiException(API_DEFAULT_ERROR_CODE);
            }
