...
// ***********************************************************************
// <copyright file="ACI_318_11.cs" company="">
//     Copyright ©  2017
// </copyright>
// <summary></summary>
// ***********************************************************************
...
namespace MPT.CSI.API.Core.Program.ModelBehavior.Design.CodesDesign.Concrete
{
    ...
    public class ACI_318_11 : ConcreteCode
    {
        ...
        {
            _callCode = _sapModel.DesignConcrete.ACI318_11.GetOverwrite(name, (int)item, ref value, ref programDetermined);
        ...
        {
            _callCode = _sapModel.DesignConcrete.ACI318_11.SetOverwrite(name, 
                            (int)item, value,
        ...
        public void GetPreference(ePreferences_ACI_318_08 item,
            ref double value)
        {
            _callCode = _sapModel.DesignConcrete.ACI318_11.GetPreference((int)item, ref value);
            if (throwCurrentApiException(_callCode)) { throw new CSiException(API_DEFAULT_ERROR_CODE); }
        }
