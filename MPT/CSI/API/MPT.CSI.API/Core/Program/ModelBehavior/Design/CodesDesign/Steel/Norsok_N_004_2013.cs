...
// ***********************************************************************
// <copyright file="Norsok_N_004_2013.cs" company="">
//     Copyright ©  2017
// </copyright>
// <summary></summary>
// ***********************************************************************
...
{
    /// <summary>
    /// Steel design code <see cref="Norsok_N_004_2013" />.
    /// </summary>
    /// <seealso cref="MPT.CSI.API.Core.Program.ModelBehavior.Design.CodesDesign.Steel.SteelCode" />
    /// <seealso cref="SteelCode" />
    public class Norsok_N_004_2013 : SteelCode
    {
        #region Initialization
        /// <summary>
        /// Initializes a new instance of the <see cref="Norsok_N_004_2013" /> class.
        /// </summary>
        /// <param name="seed">The seed.</param>
        public Norsok_N_004_2013(CSiApiSeed seed) : base(seed) { }
        ...
        {
            _callCode = _sapModel.DesignSteel.Norsok_N0042013.GetOverwrite(name, (int)item, ref value, ref programDetermined);
        ...
        {
            _callCode = _sapModel.DesignSteel.Norsok_N0042013.SetOverwrite(name, 
                            (int)item, value, 
        ...
        public void GetPreference(ePreferences_Norsok_N_004_2013 item,
            ref double value)
        {
            _callCode = _sapModel.DesignSteel.Norsok_N0042013.GetPreference((int)item, ref value);
            if (throwCurrentApiException(_callCode)) { throw new CSiException(API_DEFAULT_ERROR_CODE); }
        }
        ...
        public void SetPreference(ePreferences_Norsok_N_004_2013 item,
            double value)
        {
            _callCode = _sapModel.DesignSteel.Norsok_N0042013.SetPreference((int)item, value);
            if (throwCurrentApiException(_callCode)) { throw new CSiException(API_DEFAULT_ERROR_CODE); }
        }
#endregion
    }
