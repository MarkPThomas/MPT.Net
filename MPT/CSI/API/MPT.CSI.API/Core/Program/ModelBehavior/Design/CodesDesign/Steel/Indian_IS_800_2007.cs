...
// ***********************************************************************
// <copyright file="Indian_IS_800_2007.cs" company="">
//     Copyright ©  2017
// </copyright>
// <summary></summary>
// ***********************************************************************
...
{
    /// <summary>
    /// Steel design code <see cref="Indian_IS_800_2007" />.
    /// </summary>
    /// <seealso cref="MPT.CSI.API.Core.Program.ModelBehavior.Design.CodesDesign.Steel.SteelCode" />
    /// <seealso cref="SteelCode" />
    public class Indian_IS_800_2007 : SteelCode
    {
        #region Initialization

        /// <summary>
        /// Initializes a new instance of the <see cref="Indian_IS_800_2007" /> class.
        /// </summary>
        /// <param name="seed">The seed.</param>
        public Indian_IS_800_2007(CSiApiSeed seed) : base(seed)
        {
        }
        ...
        {
            _callCode = _sapModel.DesignSteel.Indian_IS_800_2007.GetOverwrite(name, (int) item, ref value,
        ...
        /// <exception cref="CSiException"><see cref="CSiApiBase.API_DEFAULT_ERROR_CODE" /></exception>
        public void GetPreference(ePreferences_Indian_IS_800_2007 item,
            ref double value)
        {
            _callCode = _sapModel.DesignSteel.Indian_IS_800_2007.GetPreference((int) item, ref value);
            if (throwCurrentApiException(_callCode))
            {
                throw new CSiException(API_DEFAULT_ERROR_CODE);
            }
        ...
        /// <param name="value">The value of the considered preference item.</param>
        /// <exception cref="CSiException"><see cref="CSiApiBase.API_DEFAULT_ERROR_CODE" /></exception>
        public void SetPreference(ePreferences_Indian_IS_800_2007 item,
            double value)
        {
            _callCode = _sapModel.DesignSteel.Indian_IS_800_2007.SetPreference((int) item, value);
            if (throwCurrentApiException(_callCode))
            {
                throw new CSiException(API_DEFAULT_ERROR_CODE);
            }
