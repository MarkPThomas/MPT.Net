...
// ***********************************************************************
// <copyright file="DesignAluminum.cs" company="">
//     Copyright ©  2017
// </copyright>
// <summary></summary>
// ***********************************************************************
...
namespace MPT.CSI.API.Core.Program.ModelBehavior.Design
{
    ...
    /// <seealso cref="MPT.CSI.API.Core.Program.ModelBehavior.Design.IDesignAluminum" />
    public class DesignAluminum : CSiApiBase, IDesignAluminum
    {
        #region Properties        
        /// <summary>
        ...
        public AluminumCode Code { get; private set; }
        ...
        public DesignAluminum(CSiApiSeed seed, 
            AluminumCode code) : base(seed)
        {
            Code = code;
        }
        #endregion
        ...
        {
            _callCode = _sapModel.DesignAluminum.DeleteResults();
        ...
        {
            _callCode = _sapModel.DesignAluminum.ResetOverwrites();
            if (throwCurrentApiException(_callCode)) { throw new CSiException(API_DEFAULT_ERROR_CODE); }
        }
        ...
        {
            _callCode = _sapModel.DesignAluminum.StartDesign();
            if (throwCurrentApiException(_callCode)) { throw new CSiException(API_DEFAULT_ERROR_CODE); }
        }
        ...
        {
            _callCode = _sapModel.DesignAluminum.GetCode(ref codeName);
            if (throwCurrentApiException(_callCode)) { throw new CSiException(API_DEFAULT_ERROR_CODE); }
        }
        ...
        {
            _callCode = _sapModel.DesignAluminum.SetCode(codeName);
            if (throwCurrentApiException(_callCode)) { throw new CSiException(API_DEFAULT_ERROR_CODE); }
        }
        ...
        {
            _callCode = _sapModel.DesignAluminum.SetDesignSection(itemName, nameSection, 
                            resetToLastAnalysisSection, 
        ...
        {
            _callCode = _sapModel.DesignAluminum.GetGroup(ref _numberOfItems, ref nameGroups);
            if (throwCurrentApiException(_callCode)) { throw new CSiException(API_DEFAULT_ERROR_CODE); }
        }
        ...
        {
            _callCode = _sapModel.DesignAluminum.GetComboAutoGenerate(ref autoGenerate);
            if (throwCurrentApiException(_callCode)) { throw new CSiException(API_DEFAULT_ERROR_CODE); }
        }
        ...
        {
            _callCode = _sapModel.DesignAluminum.GetComboDeflection(ref _numberOfItems, ref nameLoadCombinations);
            if (throwCurrentApiException(_callCode)) { throw new CSiException(API_DEFAULT_ERROR_CODE); }
        }
        ...
        {
            _callCode = _sapModel.DesignAluminum.GetComboStrength(ref _numberOfItems, ref nameLoadCombinations);
            if (throwCurrentApiException(_callCode)) { throw new CSiException(API_DEFAULT_ERROR_CODE); }
        }
        ...
        public void GetSummaryResults(string name, 
            ...
            eItemType itemType = eItemType.Object)
        {
            _callCode = _sapModel.DesignAluminum.GetSummaryResults(name, ref _numberOfItems, 
        ...
        public void SetAutoSelectNull(string itemName, 
            eItemType itemType = eItemType.Object)
        {
            _callCode = _sapModel.DesignAluminum.SetAutoSelectNull(itemName, 
                            EnumLibrary.Convert<eItemType, CSiProgram.eItemType>(itemType));
            if (throwCurrentApiException(_callCode)) { throw new CSiException(API_DEFAULT_ERROR_CODE); }
        }
#endregion
