...
// ***********************************************************************
// <copyright file="Eurocode_3_2005.cs" company="">
//     Copyright ©  2017
// </copyright>
// <summary></summary>
// ***********************************************************************
...
{
    /// <summary>
    /// Steel design code <see cref="Eurocode_3_2005" />.
    /// </summary>
    /// <seealso cref="MPT.CSI.API.Core.Program.ModelBehavior.Design.CodesDesign.Steel.SteelCode" />
    /// <seealso cref="SteelCode" />
    public class Eurocode_3_2005 : SteelCode
    {
        #region Initialization
        /// <summary>
        /// Initializes a new instance of the <see cref="Eurocode_3_2005" /> class.
        /// </summary>
        /// <param name="seed">The seed.</param>
        public Eurocode_3_2005(CSiApiSeed seed) : base(seed) { }
        ...
        {
            _callCode = _sapModel.DesignSteel.Eurocode_3_2005.GetOverwrite(name, (int)item, ref value, ref programDetermined);
        ...
        {
            _callCode = _sapModel.DesignSteel.Eurocode_3_2005.SetOverwrite(name, 
                            (int)item, value, 
        ...
        public void GetPreference(ePreferences_Eurocode_3_2005 item,
            ref double value)
        {
            _callCode = _sapModel.DesignSteel.Eurocode_3_2005.GetPreference((int)item, ref value);
            if (throwCurrentApiException(_callCode)) { throw new CSiException(API_DEFAULT_ERROR_CODE); }
        }
        ...
        public void SetPreference(ePreferences_Eurocode_3_2005 item,
            double value)
        {
            _callCode = _sapModel.DesignSteel.Eurocode_3_2005.SetPreference((int)item, value);
            if (throwCurrentApiException(_callCode)) { throw new CSiException(API_DEFAULT_ERROR_CODE); }
        }
        #endregion
    }
