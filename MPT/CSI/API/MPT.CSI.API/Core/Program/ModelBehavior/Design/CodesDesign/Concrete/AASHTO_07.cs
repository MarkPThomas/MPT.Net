...
// ***********************************************************************
// <copyright file="AASHTO_07.cs" company="">
//     Copyright ©  2017
// </copyright>
// <summary></summary>
// ***********************************************************************
...
namespace MPT.CSI.API.Core.Program.ModelBehavior.Design.CodesDesign.Concrete
{
    ...
    public class AASHTO_07 : ConcreteCode
    {
...
#region Methods: Public
        ...
        {
            _callCode = _sapModel.DesignConcrete.AASHTO_Concrete_07.GetOverwrite(name, (int)item, ref value, ref programDetermined);
        ...
        {
            _callCode = _sapModel.DesignConcrete.AASHTO_Concrete_07.SetOverwrite(name, 
                            (int)item, value, 
        ...
        public void GetPreference(ePreferences_AASHTO_07 item,
            ref double value)
        {
            _callCode = _sapModel.DesignConcrete.AASHTO_Concrete_07.GetPreference((int)item, ref value);
            if (throwCurrentApiException(_callCode)) { throw new CSiException(API_DEFAULT_ERROR_CODE); }
        }
