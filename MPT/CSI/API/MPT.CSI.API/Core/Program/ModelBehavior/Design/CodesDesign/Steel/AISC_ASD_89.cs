...
// ***********************************************************************
// <copyright file="AISC_ASD_89.cs" company="">
//     Copyright ©  2017
// </copyright>
// <summary></summary>
// ***********************************************************************
...
{
    /// <summary>
    /// Steel design code <see cref="AISC_ASD_89" />.
    /// </summary>
    /// <seealso cref="MPT.CSI.API.Core.Program.ModelBehavior.Design.CodesDesign.Steel.SteelCode" />
    /// <seealso cref="SteelCode" />
    public class AISC_ASD_89 : SteelCode
    {
        #region Initialization
        /// <summary>
        /// Initializes a new instance of the <see cref="AISC_ASD_89" /> class.
        /// </summary>
        /// <param name="seed">The seed.</param>
        public AISC_ASD_89(CSiApiSeed seed) : base(seed) { }
        ...
        {
            _callCode = _sapModel.DesignSteel.AISC_ASD89.GetOverwrite(name, (int)item, ref value, ref programDetermined);
