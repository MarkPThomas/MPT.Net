...
// ***********************************************************************
// <copyright file="AISC_LRFD_93.cs" company="">
//     Copyright ©  2017
// </copyright>
// <summary></summary>
// ***********************************************************************
...
{
    /// <summary>
    /// Steel design code <see cref="AISC_LRFD_93" />.
    /// </summary>
    /// <seealso cref="MPT.CSI.API.Core.Program.ModelBehavior.Design.CodesDesign.Steel.SteelCode" />
    /// <seealso cref="SteelCode" />
    public class AISC_LRFD_93 : SteelCode
    {
        #region Initialization

        /// <summary>
        /// Initializes a new instance of the <see cref="AISC_LRFD_93" /> class.
        /// </summary>
        /// <param name="seed">The seed.</param>
        public AISC_LRFD_93(CSiApiSeed seed) : base(seed)
        {
        }
        ...
        {
            _callCode = _sapModel.DesignSteel.AISC_LRFD93.GetOverwrite(name, (int) item, ref value,
        ...
        {
            _callCode = _sapModel.DesignSteel.AISC_LRFD93.SetOverwrite(name, 
                            (int) item, value,
        ...
        public void GetPreference(ePreferences_AISC_LRFD_93 item,
            ref double value)
        {
            _callCode = _sapModel.DesignSteel.AISC_LRFD93.GetPreference((int) item, ref value);
            if (throwCurrentApiException(_callCode))
            {
                throw new CSiException(API_DEFAULT_ERROR_CODE);
            }
        ...
        public void SetPreference(ePreferences_AISC_LRFD_93 item,
            double value)
        {
            _callCode = _sapModel.DesignSteel.AISC_LRFD93.SetPreference((int) item, value);
            if (throwCurrentApiException(_callCode))
            {
                throw new CSiException(API_DEFAULT_ERROR_CODE);
            }
