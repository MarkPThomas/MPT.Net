...
// ***********************************************************************
// <copyright file="API_RP2A_WSD_2014.cs" company="">
//     Copyright ©  2017
// </copyright>
// <summary></summary>
// ***********************************************************************
...
{
    /// <summary>
    /// Steel design code <see cref="API_RP2A_WSD_2014" />.
    /// </summary>
...
#region Methods: Public
        ...
        {
            _callCode = _sapModel.DesignSteel.API_RP2A_WSD2014.GetOverwrite(name, (int)item, ref value, ref programDetermined);
        ...
        {
            _callCode = _sapModel.DesignSteel.API_RP2A_WSD2014.SetOverwrite(name, 
                            (int)item, value, 
        ...
        public void GetPreference(ePreferences_API_RP2A_WSD_2014 item,
            ref double value)
        {
            _callCode = _sapModel.DesignSteel.API_RP2A_WSD2014.GetPreference((int)item, ref value);
            if (throwCurrentApiException(_callCode)) { throw new CSiException(API_DEFAULT_ERROR_CODE); }
        }
        ...
        public void SetPreference(ePreferences_API_RP2A_WSD_2014 item,
            double value)
        {
            _callCode = _sapModel.DesignSteel.API_RP2A_WSD2014.SetPreference((int)item, value);
            if (throwCurrentApiException(_callCode)) { throw new CSiException(API_DEFAULT_ERROR_CODE); }
        }
#endregion
    }
