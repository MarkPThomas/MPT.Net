...
// ***********************************************************************
// <copyright file="ASCE_10_97.cs" company="">
//     Copyright ©  2017
// </copyright>
// <summary></summary>
// ***********************************************************************
...
{
    /// <summary>
    /// Steel design code <see cref="ASCE_10_97" />.
    /// </summary>
    /// <seealso cref="MPT.CSI.API.Core.Program.ModelBehavior.Design.CodesDesign.Steel.SteelCode" />
    /// <seealso cref="SteelCode" />
    public class ASCE_10_97 : SteelCode
    {
        #region Initialization
        /// <summary>
        /// Initializes a new instance of the <see cref="ASCE_10_97" /> class.
        /// </summary>
        /// <param name="seed">The seed.</param>
        public ASCE_10_97(CSiApiSeed seed) : base(seed) { }
        ...
        {
            _callCode = _sapModel.DesignSteel.ASCE_10_97.GetOverwrite(name, (int)item, ref value, ref programDetermined);
        ...
        {
            _callCode = _sapModel.DesignSteel.ASCE_10_97.SetOverwrite(name, 
                            (int)item, value,
        ...
        public void GetPreference(ePreferences_ASCE_10_97 item,
            ref double value)
        {
            _callCode = _sapModel.DesignSteel.ASCE_10_97.GetPreference((int)item, ref value);
            if (throwCurrentApiException(_callCode)) { throw new CSiException(API_DEFAULT_ERROR_CODE); }
        }
        ...
        public void SetPreference(ePreferences_ASCE_10_97 item,
            double value)
        {
            _callCode = _sapModel.DesignSteel.ASCE_10_97.SetPreference((int)item, value);
            if (throwCurrentApiException(_callCode)) { throw new CSiException(API_DEFAULT_ERROR_CODE); }
        }
#endregion
    }
