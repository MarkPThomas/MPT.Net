...
// ***********************************************************************
// <copyright file="AISC_360_05_IBC_2006.cs" company="">
//     Copyright ©  2017
// </copyright>
// <summary></summary>
// ***********************************************************************
...
namespace MPT.CSI.API.Core.Program.ModelBehavior.Design.CodesDesign.Steel
{
    ...
    public class AISC_360_05_IBC_2006 : SteelCode
    {
        ...
        public void GetPreference(ePreferences_AISC_360_05 item,
            ref double value)
        {
            _callCode = _sapModel.DesignSteel.AISC360_05_IBC2006.GetPreference((int)item, ref value);
            if (throwCurrentApiException(_callCode)) { throw new CSiException(API_DEFAULT_ERROR_CODE); }
        }
        ...
        public void SetPreference(ePreferences_AISC_360_05 item,
            double value)
        {
            _callCode = _sapModel.DesignSteel.AISC360_05_IBC2006.SetPreference((int)item, value);
            if (throwCurrentApiException(_callCode)) { throw new CSiException(API_DEFAULT_ERROR_CODE); }
        }
        #endregion
    }
