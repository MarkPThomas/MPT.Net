...
namespace MPT.CSI.API.Core.Program.ModelBehavior.Design.CodesDesign.Concrete
{
    ...
    public class Italian_NTC_2008 : ConcreteCode
    {
        ...
        {
            _callCode = _sapModel.DesignConcrete.Italian_NTC_2008.GetOverwrite(name, (int)item, ref value, ref programDetermined);
        ...
        public void GetPreference(int item,
            ref double value)
        {
            _callCode = _sapModel.DesignConcrete.Italian_NTC_2008.GetPreference((int)item, ref value);
            if (throwCurrentApiException(_callCode)) { throw new CSiException(API_DEFAULT_ERROR_CODE); }            
        }
        ...
        public void SetPreference(int item,
            double value)
        {
            _callCode = _sapModel.DesignConcrete.Italian_NTC_2008.SetPreference((int)item, value);
            if (throwCurrentApiException(_callCode)) { throw new CSiException(API_DEFAULT_ERROR_CODE); }
        }
#endregion
    }
