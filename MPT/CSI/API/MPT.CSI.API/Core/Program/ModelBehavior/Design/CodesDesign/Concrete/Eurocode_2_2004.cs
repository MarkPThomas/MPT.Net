...
// ***********************************************************************
// <copyright file="Eurocode_2_2004.cs" company="">
//     Copyright ©  2017
// </copyright>
// <summary></summary>
// ***********************************************************************
...
{
    /// <summary>
    /// Concrete design code <see cref="Eurocode_2_2004" />.
    /// </summary>
    /// <seealso cref="MPT.CSI.API.Core.Program.ModelBehavior.Design.CodesDesign.Concrete.ConcreteCode" />
    /// <seealso cref="ConcreteCode" />
    public class Eurocode_2_2004 : ConcreteCode
    {
        #region Initialization        
        /// <summary>
        /// Initializes a new instance of the <see cref="Eurocode_2_2004" /> class.
        /// </summary>
        /// <param name="seed">The seed.</param>
        public Eurocode_2_2004(CSiApiSeed seed) : base(seed) { }
        ...
        {
            _callCode = _sapModel.DesignConcrete.Eurocode_2_2004.GetOverwrite(name, (int)item, ref value, ref programDetermined);
        ...
        {
            _callCode = _sapModel.DesignConcrete.Eurocode_2_2004.SetOverwrite(name, 
                            (int)item, value, 
        ...
        public void GetPreference(ePreferences_Eurocode_2_2004 item,
            ref double value)
        {
            _callCode = _sapModel.DesignConcrete.Eurocode_2_2004.GetPreference((int)item, ref value);
            if (throwCurrentApiException(_callCode)) { throw new CSiException(API_DEFAULT_ERROR_CODE); }
        }
        ...
        public void SetPreference(ePreferences_Eurocode_2_2004 item,
            double value)
        {
            _callCode = _sapModel.DesignConcrete.Eurocode_2_2004.SetPreference((int)item, value);
            if (throwCurrentApiException(_callCode)) { throw new CSiException(API_DEFAULT_ERROR_CODE); }
        }
        #endregion
    }
