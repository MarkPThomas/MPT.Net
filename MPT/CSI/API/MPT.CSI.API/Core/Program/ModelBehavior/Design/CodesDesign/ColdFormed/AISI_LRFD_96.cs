...
// ***********************************************************************
// <copyright file="AISI_LRFD_96.cs" company="">
//     Copyright ©  2017
// </copyright>
// <summary></summary>
// ***********************************************************************
...
{
    /// <summary>
    /// Cold-formed steel design code <see cref="AISI_LRFD_96" />.
    /// </summary>
    ...
    public class AISI_LRFD_96 : ColdFormedSteelCode
    {
        #region Initialization        
        /// <summary>
        /// Initializes a new instance of the <see cref="AISI_LRFD_96" /> class.
        /// </summary>
        ...
        /// <summary>
        /// Returns the value of a cold formed design overwrite item.
        /// </summary>
        ...
        {
            _callCode = _sapModel.DesignColdFormed.AISI_LRFD96.GetOverwrite(name, (int)item, ref value, ref programDetermined);
            if (throwCurrentApiException(_callCode)) { throw new CSiException(API_DEFAULT_ERROR_CODE); }            
        }

        /// <summary>
        /// Sets the value of a cold formed design overwrite item.
        /// </summary>
        ...
        /// <summary>
        /// Returns the value of a cold formed design preference item.
        /// </summary>
        ...
        public void GetPreference(ePreferences_AISI_LRFD_96 item,
            ref double value)
        {       
            _callCode = _sapModel.DesignColdFormed.AISI_LRFD96.GetPreference((int)item, ref value);
            if (throwCurrentApiException(_callCode)) { throw new CSiException(API_DEFAULT_ERROR_CODE); }            
        }

        /// <summary>
        /// Sets the value of a cold formed design preference item.
        /// </summary>
        /// <param name="item">The preference item considered.</param>
        /// <param name="value">The value of the considered preference item.</param>
        /// <exception cref="CSiException"><see cref="CSiApiBase.API_DEFAULT_ERROR_CODE" /></exception>
        public void SetPreference(ePreferences_AISI_LRFD_96 item,
            double value)
        {
            _callCode = _sapModel.DesignColdFormed.AISI_LRFD96.SetPreference((int)item, value);
            if (throwCurrentApiException(_callCode)) { throw new CSiException(API_DEFAULT_ERROR_CODE); }
        }
#endregion
    }
