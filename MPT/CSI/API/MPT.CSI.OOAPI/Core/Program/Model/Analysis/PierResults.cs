...
namespace MPT.CSI.OOAPI.Core.Program.Model.Analysis
{
    ...
    public class PierResults : AnalysisResults
    {
        ...
        internal PierResults(ApiCSiApplication app) : base(app) { }
        #endregion
        ...
        {
            Forces = GetPierForces(_apiAnalysisResults);
        }
        ...
        public static List<Tuple<PierSpandrelResultsIdentifier, Forces>> GetPierForces(IResults app)
        {
            app.PierForce(
                out var storyNames,
                out var pierNames,
