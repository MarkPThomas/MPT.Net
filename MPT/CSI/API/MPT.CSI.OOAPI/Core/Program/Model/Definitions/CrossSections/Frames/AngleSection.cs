...
namespace MPT.CSI.OOAPI.Core.Program.Model.Definitions.CrossSections.Frames
{
    ...
    /// Class AngleSection.
    /// </summary>
    /// <seealso cref="MPT.CSI.OOAPI.Core.Program.Model.Definitions.CrossSections.Frames.FrameSection{AngleSectionProperties}" />
    public class AngleSection : FrameSection<AngleSectionProperties>
    {
        ...
        {
            AngleSection frameSection = new AngleSection(app, material, uniqueName) {_sectionProperties = properties};
            if (properties == null)
            {
        ...
        {
            _apiFrameSection.GetAngle(Name,
                out var fileName,
            ...
            FileName = fileName;
            if (!(_sectionProperties is AngleSectionProperties)) return;
            _sectionProperties = new AngleSectionProperties
            {
        ...
        /// <param name="properties">The properties.</param>
        /// <returns>AngleSection.</returns>
        internal static AngleSection Add(
            ApiCSiApplication app,
            Materials.Materials material, 
            string uniqueName, 
            AngleSectionProperties properties)
        {
        ...
        /// <exception cref="CSiException"><see cref="CSiApiBase.API_DEFAULT_ERROR_CODE" /></exception>
        protected override void set(string name, AngleSectionProperties properties)
        {
        ...
        /// <param name="properties">The properties.</param>
        /// <exception cref="CSiException"><see cref="CSiApiBase.API_DEFAULT_ERROR_CODE" /></exception>
        protected static void setApi(ApiFrameSection apiFrameSection, string name, AngleSectionProperties properties)
        {
            apiFrameSection.SetAngle(
                name,
