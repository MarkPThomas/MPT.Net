...
namespace MPT.CSI.OOAPI.Core.Program.Model.Design
{
    ...
    /// Class DesignResults.
    /// </summary>
    public abstract class DesignResults : CSiOoApiBaseBase, IFill
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="DesignResults"/> class.
        /// </summary>
        /// <param name="app">The application.</param>
        protected DesignResults(ApiCSiApplication app) : base(app) { }
...
#if !BUILD_SAP2000v16 && !BUILD_SAP2000v17
        /// <summary>
        /// True: Design results are available.
        /// </summary>
        ...
        {
            _resultsAreAvailable = app.ResultsAreAvailable();
