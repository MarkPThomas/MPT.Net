...
namespace MPT.CSI.OOAPI.Core.Helpers.Definitions.Materials
{
    ...
    public class TendonTemplate : MaterialTemplate
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TendonTemplate" /> class.
        /// </summary>
        /// <param name="region">The region.</param>
        /// <param name="standard">The standard.</param>
        /// <param name="grade">The grade.</param>
        public TendonTemplate(
            eMaterialRegion region,
            string standard,
            string grade) : base(eMaterialPropertyType.Tendon, region, standard, grade)
        {
        }
