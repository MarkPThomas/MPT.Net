...
// ***********************************************************************
// <copyright file="GridTemplate.cs" company="">
//     Copyright ©  2018
// </copyright>
// <summary></summary>
// ***********************************************************************
...
#if BUILD_ETABS2013 || BUILD_ETABS2014 || BUILD_ETABS2015 || BUILD_ETABS2016 || BUILD_ETABS2017
namespace MPT.CSI.OOAPI.Core.Helpers.StructureLayout
{
    /// <summary>
    /// Creates a new grid-only model from template.
    /// </summary>
    public class GridTemplate : ApiProperty
    {
        /// <summary>
