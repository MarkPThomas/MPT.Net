...
namespace MPT.CSI.OOAPI.Core.Helpers.Loads.Definitions
{
    ...
    /// Class LoadFunction.
    /// </summary>
    public class LoadResponseSpectrum : ApiProperty
    {
        ...
        /// <summary>
        /// The angle between the acceleration local-1 axis and the +X-axis of the coordinate system specified by <see cref="CoordinateSystems" />.
