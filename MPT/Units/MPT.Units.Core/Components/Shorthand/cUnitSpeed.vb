...
#Region "Enumerations"
    ...
    Friend Enum eUnit
        <Description("")> None
        <Description("fps")> FeetPerSecond
        <Description("mph")> MilesPerHour
        <Description("kph")> KilometersPerHour
    End Enum
#End Region
...
#Region "Properties: Friend"
    ...
    ''' <returns></returns>
    ''' <remarks></remarks>
    Friend Shared ReadOnly Property UnitDefault As eUnit = eUnit.FeetPerSecond
...
#Region "Methods: Friend"
    ...
    Friend Overloads Shared Function GetUnits(ByVal shorthandUnitName As eUnit) As cUnits
        Dim unitLength As New cUnit(eUnitType.Length)
        ...
        Select Case shorthandUnitName
            ...
            Case eUnit.MilesPerHour
                unitLength.SetUnitName(GetEnumDescription(cUnitLength.eUnit.Mile))
                unitTime.SetUnitName(GetEnumDescription(cUnitTime.eUnit.Hour))
            Case eUnit.KilometersPerHour
                unitLength.SetUnitName(GetEnumDescription(cUnitLength.eUnit.Kilometer))
                unitTime.SetUnitName(GetEnumDescription(cUnitTime.eUnit.Hour))
        End Select
